                ...
                {orders.map((x, i) => {
                  return (
                    <tr key={x.OrderID}>
                      ...
                      <td style={{ color: "#576271" }}>
                        {orders[i].Date.toDate().getDate() +
                          "-" +
                          orders[i].Date.toDate().getMonth() +
                          "-" +
                          orders[i].Date.toDate().getFullYear()}
                      </td>
                      <td style={{ color: "#576271" }}>
                        Rs. {orders[i].Subtotal}\-
                      </td>
                      <td>
                        <button className="btn btn-danger redbox" disabled>
                          {orders[i].Tracking}
                        </button>
                      </td>
                      <Link to="/orderdetails">
                        <td>
                          <button
                            onClick={handleOrderDetails(orders[i])}
                      ...
                      {orders[i].Tracking === "Cancelled" ||
                      orders[i].Tracking === "Completed" ||
                      orders[i].Tracking === "Done" ||
                      orders[i].Tracking === "Rejected" ? (
                        <td>
                          <button className="btn btn-danger redbox" disabled>
                            Cancel
                          </button>
