...
function CSupport() {
  ...
  function checkInputField() {
    ...
    if (subject === "" || message === "" || rating === null) {
  ...
  async function sendEmail(e) {
    if (check == false) {
      ...
      try {
        await firebase_integration.addFeedback(
          firebase_integration.auth.currentUser.uid,
          todaysdate,
          parseInt(template_params.rating),
          template_params.subject,
