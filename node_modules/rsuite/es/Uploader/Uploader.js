...
function (_React$Component) {
  ...
  _proto.renderUploadTrigger = function renderUploadTrigger() {
    var _this$props11 = this.props,
        ...
        rest = _objectWithoutPropertiesLoose(_this$props11, ["name", "multiple", "disabled", "accept", "children", "toggleComponentClass", "dragable"]);
  ...
  _proto.render = function render() {
    ...
    var classes = classNames(className, classPrefix, this.addPrefix(listType), (_classNames = {}, _classNames[this.addPrefix('dragable')] = dragable, _classNames));
