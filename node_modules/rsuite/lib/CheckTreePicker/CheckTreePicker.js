  ...
  _proto.flattenNodes = function flattenNodes(nodes, props, ref, parentNode, layer) {
    ...
    nodes.forEach(function (node, index) {
      ...
      _this7.nodes[refKey] = (_this7$nodes$refKey = {
        layer: layer
      }, _this7$nodes$refKey[labelKey] = node[labelKey], _this7$nodes$refKey[valueKey] = node[valueKey], _this7$nodes$refKey.expand = (0, _treeUtils.getExpandState)(node, props || _this7.props), _this7$nodes$refKey.uncheckable = (0, _utils3.getUncheckableState)(node, props || _this7.props), _this7$nodes$refKey.refKey = refKey, _this7$nodes$refKey);
      ...
      Object.keys(lists).forEach(function (listKey) {
        if (listKey === 'check') {
          ...
          lists[listKey].forEach(function (value) {
            if ((0, _utils.shallowEqual)(_this8.nodes[refKey][valueKey], value) && !uncheckableItemValues.some(function (uncheckableValue) {
        ...
        if (listKey === 'expand') {
          ...
          if (lists[listKey].length) {
            lists[listKey].forEach(function (value) {
              if ((0, _utils.shallowEqual)(_this8.nodes[refKey][valueKey], value)) {
                _this8.nodes[refKey][listKey] = true;
              }
            });
          } else {
