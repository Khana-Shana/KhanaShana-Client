...
export declare type FormContextValues<FormValues extends FieldValues = FieldValues> = {
    ...
    getValues(): IsFlatObject<FormValues> extends false ? Record<string, any> : FormValues;
    getValues<T extends boolean>(payload: {
        nest: T;
    }): T extends true ? FormValues : IsFlatObject<FormValues> extends true ? FormValues : Record<string, any>;
