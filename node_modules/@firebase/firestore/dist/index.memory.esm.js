...
var b = {
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new A(b.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new A(b.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new A(b.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new A(b.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
...
var D = /** @class */ function() {
    ...
    n.K = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new A(b.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
var L = /^[_a-zA-Z][_a-zA-Z0-9]*$/, O = /** @class */ function(e) {
    ...
    n.Z = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new A(b.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new A(b.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new A(b.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new A(b.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n;
}(D);
...
var C = /** @class */ function() {
    ...
    t.prototype.lt = function() {
        return new q(this.root, null, this.k, !1);
    }, t.prototype._t = function(t) {
        return new q(this.root, t, this.k, !1);
    }, t.prototype.dt = function() {
        return new q(this.root, null, this.k, !0);
    }, t.prototype.ft = function(t) {
        return new q(this.root, t, this.k, !0);
    }, t;
}(), q = /** @class */ function() {
    function t(t, e, n, r) {
        this.wt = r, this.Tt = [];
...
var P = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.Nt = function(t) {
        ...
        return new x(this.data.lt());
    }, t.prototype._t = function(t) {
        return new x(this.data._t(t));
    }, 
...
/** Extracts the backend's type order for the provided value. */ function J(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? H(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : Ve("Invalid value type: " + JSON.stringify(t));
}

/** Tests `left` and `right` for equality based on the backend semantics. */ function X(t, e) {
    var n = J(t);
    if (n !== J(e)) return !1;
    switch (n) {
      case 0 /* NullValue */ :
      ...
      case 9 /* ArrayValue */ :
        return Ce(t.arrayValue.values || [], e.arrayValue.values || [], X);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            var n = t.mapValue.fields || {}, r = e.mapValue.fields || {};
            if (G(n) !== G(r)) return !1;
            for (var i in n) if (n.hasOwnProperty(i) && (void 0 === r[i] || !X(n[i], r[i]))) return !1;
            return !0;
        }(t, e);
...
var ft = /** @class */ function() {
    ...
    return t.prototype.qt = function(t, e) {
        ...
        return e instanceof t && Ce(this.elements, e.elements, X);
    }, t;
}(), lt = /** @class */ function() {
    function t(t) {
        this.elements = t;
    ...
    t.prototype.xt = function(t) {
        ...
        return e instanceof t && X(this.Qt, e.Qt);
...
var wt = /** @class */ function() {
    ...
    return t(n, e), n.prototype.Bt = function(t, e) {
        ...
        return this.Yt(t), this.Zt.Jt(t) ? new Rt(this.key, R.S()) : t;
    }, n.prototype.ee = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var _t = /** @class */ function() {
    ...
    return t(n, e), n.prototype.field = function(t) {
        ...
        return null !== r && null !== i ? Z(r, i) : Ve("Trying to compare documents on fields that don't exist");
    }, n;
    ...
    t.prototype.Ue = function() {
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.et(this.collectionGroup) && this.path.B(e) : U.st(this.path) ? this.path.isEqual(e) : this.path.W(e);
    }, 
    /**
...
var Ut = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        ...
        if (ut(r)) {
            if (e !== Ot.EQUAL) throw new A(b.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (at(r)) {
            if (e !== Ot.EQUAL) throw new A(b.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        ...
        // Only compare types with matching backend order (such as double and int).
                return null !== e && J(this.value) === J(e) && this.Ye(Z(e, this.value));
        ...
        return t instanceof n && this.op.isEqual(t.op) && this.field.isEqual(t.field) && X(this.value, t.value);
    }, n.prototype.toString = function() {
...
var Ft, jt, Bt = /** @class */ function() {
    ...
    t.prototype.Je = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? U.k(U.tt(o.referenceValue), e.key) : Z(o, e.field(i.field)), 
        ...
        for (var e = 0; e < this.position.length; e++) if (!X(this.position[e], t.position[e])) return !1;
        return !0;
    }, t;
}(), zt = /** @class */ function() {
    function t(t, e) {
...
}(), Qt = new zt(O.X(), Gt.ASCENDING), Ht = new zt(O.X(), Gt.DESCENDING), Yt = /** @class */ function() {
    function t(
     ...
     */ , s) {
        void 0 === i && (i = R.MIN), void 0 === o && (o = R.MIN), void 0 === s && (s = B.Ut), 
 ...
 */ var ae = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, le.Is(e, n)), new t(R.MIN, r, ue(), Zt(), oe());
    }, t;
}(), le = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = B.Ut), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    t.prototype.ri = function(t) {
        ...
        return this.js = Zt(), this.Gs = ge(), this.zs = new P(Ue), i;
    }, 
    /**
    ...
    t.prototype.qs = function(t) {
        ...
        var e = this.Gs.get(t);
        return e || (e = new P(Ue), this.Gs = this.Gs.nt(t, e)), e;
    }, 
    /**
 ...
 */ var Ee = function() {
    ...
    t.prototype.mi = function(t) {
        ...
        B.fromBase64String(t || "")) : (Le(void 0 === t || t instanceof Uint8Array, "value must be undefined or Uint8Array"), 
        B.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.F(t.F());
    }, t.prototype.fromVersion = function(t) {
        return Le(!!t, "Trying to deserialize version that isn't set"), R.v(this.v(t));
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.yi = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            d.document;
            var y = this.tt(d.document), v = d.readTime ? this.fromVersion(d.readTime) : R.S(), m = new Rt(y, v), g = d.removedTargetIds || [];
            e = new pe([], g, m.key, m);
...
function(t, e, n, r, i) {
     ...
     */
    t.prototype.Nn = function(t) {
        var e = this, n = U.EMPTY, r = new je(n, t), i = new je(n, t + 1), o = [];
        ...
        var e = U.EMPTY, n = new je(e, t), r = new je(e, t + 1), i = oe();
    ...
    return t.me = function(t, e) {
        return U.k(t.key, e.key) || Ue(t.On, e.On);
    }, 
    /** Compare by ID then by key */ t.bn = function(t, e) {
        return Ue(t.On, e.On) || U.k(t.key, e.key);
    }, t;
}(), Be = /** @class */ function() {
    function t(t) {
        var e = this;
    ...
    t.prototype.rr = function(t, e, n) {
        ...
        return this.Yn(t, new U(e)).next((function(t) {
            var e = ee();
...
var Ye = function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.br && (this.clearTimeout(), this.gr.reject(new A(b.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.ms.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof Rt && h.version.isEqual(R.MIN) ? (
    ...
    t.prototype.lo = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.oo(o, t.Ue()).next((function(t) {
                ...
                return n.hh.rr(o, t, e ? r : R.MIN, e ? i : oe());
            })).next((function(t) {
                return {
                    documents: t,
                    do: i
 ...
 */ function $e(t, e) {
    if (0 !== e.length) throw new A(b.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + mn(e.length, "argument") + ".");
}
 ...
 */ function tn(t, e, n) {
    if (e.length !== n) throw new A(b.INVALID_ARGUMENT, "Function " + t + "() requires " + mn(n, "argument") + ", but was called with " + mn(e.length, "argument") + ".");
}
 ...
 */ function en(t, e, n) {
    if (e.length < n) throw new A(b.INVALID_ARGUMENT, "Function " + t + "() requires at least " + mn(n, "argument") + ", but was called with " + mn(e.length, "argument") + ".");
}
 ...
 */ function nn(t, e, n, r) {
    if (e.length < n || e.length > r) throw new A(b.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + mn(e.length, "argument") + ".");
}
...
function an(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = fn(r);
        throw new A(b.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
...
/** Helper to validate the type of a provided input. */ function hn(t, e, n, r) {
    if (!("object" === e ? cn(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = fn(r);
        throw new A(b.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
function ln(t, e, n) {
    if (void 0 === n) throw new A(b.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + vn(e) + " argument, but it was undefined.");
}
 ...
 */ function dn(t, e, n, r) {
    var i = fn(r);
    return new A(b.INVALID_ARGUMENT, "Function " + t + "() requires its " + vn(n) + " argument to be a " + e + ", but it was: " + i);
}

function yn(t, e, n) {
    if (n <= 0) throw new A(b.INVALID_ARGUMENT, 'Function "' + t + '()" requires its ' + vn(e) + " argument to be a positive number, but it was: " + n + ".");
}
 ...
 */ function gn(t, e) {
    function n() {
        ...
        throw e && (t += " ", t += e), new A(b.INVALID_ARGUMENT, t);
    }
...
function wn() {
    if ("undefined" == typeof Uint8Array) throw new A(b.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function En() {
    if (!Ie.Ot().yo) throw new A(b.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
var Sn = /** @class */ function(e) {
    ...
    function t(t, e) {
        ...
        if (!isFinite(e) || e < -180 || e > 180) throw new A(b.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.No = t, this.ko = e;
    }
...
/** A "context" object passed around while parsing user data. */ var Mn = /** @class */ function() {
    ...
    return t.prototype.Uo = function(e) {
        ...
        return new A(b.INVALID_ARGUMENT, "Function " + this.methodName + "() called with invalid data. " + t + e);
    }, 
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.zo = function(t, e, n) {
        var r = new Mn(2 /* MergeSet */ , t, O.H);
        Fn("Data must be an object, but it was:", r, e);
        var i, o, s = this.Go(e, r);
        if (n) {
            for (var u = new P(O.k), a = 0, h = n; a < h.length; a++) {
                var c = h[a], f = void 0;
    ...
    /** Parse update data from an update() call. */ t.prototype.Ko = function(t, e) {
        var n = this, r = new Mn(1 /* Update */ , t, O.H);
        Fn("Data must be an object, but it was:", r, e);
        var i = new P(O.k), o = Tt.le();
        F(e, (function(e, s) {
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.Yo = function(t, e, n, r) {
        var i = new Mn(1 /* Update */ , t, O.H), o = [ jn(t, e) ], s = [ n ];
        ...
        for (var a = new P(O.k), h = Tt.le(), c = 0; c < o.length; ++c) {
    ...
    t.prototype.Xo = function(t, e, n) {
        void 0 === n && (n = !1);
        var r = new Mn(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t, O.H);
        return this.Jo(e, r);
    }, 
    ...
    t.prototype.Jo = function(t, e) {
        ...
        e.path && e.path.length > 0 && e.se.push(e.path) : F(t, (function(t, i) {
            var o = n.Jo(i, e.Uo(t));
            null != o && (r[t] = o);
        })), {
            mapValue: {
 ...
 */
function Gn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof S || t instanceof Ln || t instanceof bn || t instanceof Pn || t instanceof Tn);
}
 ...
 */ function Bn(t, e) {
    try {
        return function(t) {
            ...
            try {
                return new (Nn.bind.apply(Nn, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new A(b.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).vo;
    } catch (e) {
        var n = zn(e);
 ...
 */ var Qn = /** @class */ function() {
    ...
    t.prototype.ba = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new A(b.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.Da(e);
            }));
        }));
    ...
    return t(n, e), n.prototype.Fa = function(t) {
    ...
    return t.prototype.za = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.tu(), this.mutations.length > 0) throw new A(b.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        ...
        if (null !== n) {
            ...
            throw new A(b.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.su = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new A(b.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    r.isEqual(R.MIN) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this._u.Wh() ]);
    ...
    t.prototype.Qu = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                ...
                this.gu.lastStreamToken = B.Ut, this._u.Qh(B.Ut).catch(Ze)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    return t.prototype.Oc = function() {
        ...
        try {
            ...
            return !z(e) && e.catch && e.then ? e : (this.gr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Hc = this.Hc.remove(i), this.Jc.delete(t), this.cl(), o = (o = new C(U.k)).nt(i, new Rt(i, R.S())), 
                    s = oe().add(i), u = new fe(R.MIN, 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new P(Ue), o, s), [ 2 /*return*/ , this.jh(u) ]) : [ 4 /*yield*/ , this._u.co(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.hl(t, r);
                    })).catch(Ze) ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.wl = function(t) {
        this.Zc.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new A(b.CANCELLED, t));
            }));
        })), this.Zc.clear();
    }, t.prototype.ol = function(t, e) {
        var n = this.Xc[this.currentUser.s()];
        n || (n = new C(Ue)), n = n.nt(t, e), this.Xc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Pl = function() {
        ...
        this.Jc.forEach((function(e, n) {
            t.Lc.$u(n);
        })), this.Yc.kn(), this.Jc = new Map, this.Hc = new C(U.k);
    }, 
    /**
    ...
    return t.prototype.Ah = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.Me() || n.isEqual(R.MIN) ? this.xl(t, e) : this.Bl.sr(t, r).next((function(o) {
            var u = i.Ql(e, o);
            return (e.je() || e.Ge()) && i.yc(e.pe, u, r, n) ? i.xl(t, e) : (_e() <= s.DEBUG && Se("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.U(), n = t.O(), r = this.index[e] || new P(V.k), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.U(), n = t.O(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new P(V.k)).j();
    }, t;
}(), yr = /** @class */ function() {
    function t(t, e) {
        this.Jn = t, this.dh = e, 
    ...
    return t.prototype.Kl = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                U.st(i) || (i = i.child(""));
        var o = new je(new U(i), 0), s = new P(Ue);
...
vr.i_ = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.bc = function(t) {
        var e = this, n = [];
...
var Tr = /** @class */ function() {
    ...
    return t.prototype.fd = function(t) {
        ...
        var n = new Me(e.get(1), e.get(3)), r = new U(e.$(5));
    ...
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new A(b.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
        ...
        un("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Xe.nh; else {
            if (t.cacheSizeBytes !== _r && t.cacheSizeBytes < Xe.ih) throw new A(b.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Xe.ih);
    ...
    function t(r, i, o) {
        ...
        this.Pd = new Je, this.INTERNAL = {
            ...
            var u = r;
            this.Ad = u, this.Id = t.gd(u), this.yd = u.name, this.bd = new T(i);
        } else {
            var a = r;
    ...
    return t.prototype.settings = function(t) {
        ...
        var e = new kr(t);
        if (this.pd && !this.Sd.isEqual(e)) throw new A(b.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.pd) throw new A(b.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.pd && !this.pd.od) throw new A(b.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
        ...
        // case variable names.
                if (!n || "string" != typeof n) throw new A(b.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new Me(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Ad) throw new A(b.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Ad;
        },
        enumerable: !0,
        configurable: !0
        ...
        return this.Vd(), new Cr(new Lt(V.H, t), this);
        ...
        t) {
          ...
          default:
            throw new A(b.INVALID_ARGUMENT, "Invalid log level: " + t);
        }
    }, 
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        if (this.Wd) throw new A(b.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Vr = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.Md = function(e, n, r) {
        ...
        var r = this.Gd({
            ...
            next: function(i) {
                ...
                e(new A(b.UNAVAILABLE, "Failed to get document because the client is offline.")) : i.exists && i.metadata.fromCache && n && "server" === n.source ? e(new A(b.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : t(i);
            },
            error: e
        });
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        if (o.Y()) {
            if (s === Ot.ARRAY_CONTAINS || s === Ot.ARRAY_CONTAINS_ANY) throw new A(b.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + s.toString() + "' queries on FieldPath.documentId().");
            if (s === Ot.IN) {
                this.Xd(r, s);
        ...
        if (null !== this.Yd.startAt) throw new A(b.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.Yd.endAt) throw new A(b.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
    ...
    t.prototype.if = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.Yd.orderBy; r < i.length; r++) {
            ...
            if (o.field.Y()) n.push(it(this.firestore.Id, t.key)); else {
                ...
                if (null === s) {
                    var u = o.field.G();
                    throw new A(b.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.nf = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                if (!this.Yd.He() && -1 !== s.indexOf("/")) throw new A(b.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.Yd.path.child(V.K(s));
                if (!U.st(u)) throw new A(b.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new U(u);
        ...
        var r = this.Gd({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new A(b.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, 
    ...
    t.prototype.Zd = function(t) {
        if ("string" == typeof t) {
            ...
            if (!this.Yd.He() && -1 !== t.indexOf("/")) throw new A(b.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.Yd.path.child(V.K(t));
            if (!U.st(e)) throw new A(b.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return it(this.firestore.Id, new U(e));
        }
        if (t instanceof Vr) {
            var n = t;
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.uf.ds) throw new A(b.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Lt.ve(t), n, r) || this).df = t, t.length % 2 != 1) throw new A(b.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.G() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.q() ? null : new Vr(new U(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
...
function Pr(t, e) {
    ...
    if (pn(t, e, [ "merge", "mergeFields" ]), un(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new A(b.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + fn(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new A(b.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + fn(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof Nn;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new A(b.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
var zr = gn(Sr, "Use firebase.firestore() instead."), Qr = gn(Rr, "Use firebase.firestore().runTransaction() instead."), Hr = gn(Dr, "Use firebase.firestore().batch() instead."), Yr = gn(Vr, "Use firebase.firestore().doc() instead."), Wr = gn(Or), Jr = gn(Ur), Xr = gn(Cr), Kr = gn(qr), Zr = gn(Mr, "Use firebase.firestore().collection() instead."), $r = {
     ...
     */    return t.prototype.Cf = function(t, e) {
            ...
            u.listenOnce(y.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case v.TIMEOUT:
                        Se("Connection", 'RPC "' + t + '" timed out'), s(new A(b.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case v.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new A(i, r.message));
                            } else s(new A(b.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        Se("Connection", 'RPC "' + t + '" failed'), s(new A(b.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.Sf, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = m(), i = {
        ...
        return v(g.EventType.OPEN, (function() {
            ...
            d || (d = !0, Se("Connection", "WebChannel transport errored:", t), y.bf(new A(b.UNAVAILABLE, "The operation could not be completed")));
