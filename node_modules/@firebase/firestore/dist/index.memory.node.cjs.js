...
var LocalStore = /** @class */ (function () {
    ...
    // PORTING NOTE: Multi-tab only.
    LocalStore.prototype.getTarget = function (targetId) {
        var _this = this;
    ...
    LocalStore.prototype.getNewDocumentChanges = function () {
        ...
        return this.persistence
            ...
            .then(function (_c) {
            var changedDocs = _c.changedDocs, readTime = _c.readTime;
     ...
     */
    // PORTING NOTE: Multi-tab only.
    LocalStore.prototype.synchronizeLastDocumentChangeReadTime = function () {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c;
            var _this = this;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _c.lastDocumentChangeReadTime = _d.sent();
                        return [2 /*return*/];
                }
            });
        });
...
var TransactionRunner = /** @class */ (function () {
    function TransactionRunner(asyncQueue, remoteStore, updateFunction, deferred) {
        ...
        this.backoff = new ExponentialBackoff(this.asyncQueue, "retry_transaction" /* RetryTransaction */);
    }
...
var SyncEngine = /** @class */ (function () {
            ...
            return tslib.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        debugAssert(viewChange.limboChanges.length === 0, 'View returned limbo docs before target ack from the server.');
    ...
    SyncEngine.prototype.applyOnlineStateChange = function (onlineState, source) {
        ...
        // SharedClientState.
        if ((this.isPrimary && source === 0 /* RemoteStore */) ||
            (!this.isPrimary && source === 1 /* SharedClientState */)) {
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (documents === null) {
                            ...
                            // as applicable.
                            logDebug(LOG_TAG$2, 'Cannot apply mutation batch with id: ' + batchId);
                            return [2 /*return*/];
                        }
    ...
    SyncEngine.prototype.synchronizeQueryViewsAndRaiseSnapshots = function (targets) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var activeQueries, newViewSnapshots, _i, targets_1, targetId, targetData, queries, _c, queries_1, query, queryView, viewChange, target;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        activeQueries = [];
                    ...
                    case 3:
                        targetData = _d.sent();
                        _c = 0, queries_1 = queries;
                        _d.label = 4;
                    case 4:
                        if (!(_c < queries_1.length)) return [3 /*break*/, 7];
                        query = queries_1[_c];
                        queryView = this.queryViewsByQuery.get(query);
     ...
     */
    // PORTING NOTE: Multi-tab only
    SyncEngine.prototype.synthesizeTargetToQuery = function (target) {
    ...
    SyncEngine.prototype.applyTargetState = function (targetId, state, error) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c, changes, synthesizedRemoteEvent;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        if (this.isPrimary) {
                            ...
                            logDebug(LOG_TAG$2, 'Ignoring unexpected query state notification.');
                            return [2 /*return*/];
                        }
    ...
    SyncEngine.prototype.applyActiveTargetsChange = function (added, removed) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _i, added_1, targetId, target, targetData, _loop_2, this_1, _c, removed_1, targetId;
            var _this = this;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        targetId = added_1[_i];
                        debugAssert(!this.queriesByTarget.has(targetId), 'Trying to add an already active target');
                        return [4 /*yield*/, this.localStore.getTarget(targetId)];
                    case 2:
                        target = _d.sent();
                    ...
                    case 6:
                            ...
                            return tslib.__generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        if (!this_1.queriesByTarget.has(targetId)) {
                        ...
                        this_1 = this;
                        _c = 0, removed_1 = removed;
                        _d.label = 7;
                    case 7:
                        if (!(_c < removed_1.length)) return [3 /*break*/, 10];
                        targetId = removed_1[_c];
...
var MemoryRemoteDocumentCache = /** @class */ (function () {
    ...
    MemoryRemoteDocumentCache.prototype.getNewDocumentChanges = function (transaction, sinceReadTime) {
        throw new Error('getNewDocumentChanges() is not supported with MemoryPersistence');
    };
    MemoryRemoteDocumentCache.prototype.getLastReadTime = function (transaction) {
...
var MemoryTargetCache = /** @class */ (function () {
    ...
    MemoryTargetCache.prototype.getTargetDataForTarget = function (transaction, targetId) {
...
var AsyncQueue = /** @class */ (function () {
    ...
    AsyncQueue.prototype.runDelayedOperationsEarly = function (lastTimerId) {
        ...
        return this.drain().then(function () {
            debugAssert(lastTimerId === "all" /* All */ ||
...
var Firestore = /** @class */ (function () {
    ...
    function Firestore(databaseIdOrApp, authProvider, persistenceProvider) {
        var _this = this;
        if (persistenceProvider === void 0) { persistenceProvider = new MemoryComponentProvider(); }
    ...
    Firestore.prototype.createDataReader = function (databaseId) {
        ...
        var serializer = new JsonProtoSerializer(databaseId, {
...
var GrpcConnection = /** @class */ (function () {
    ...
    GrpcConnection.prototype.openStream = function (rpcName, token) {
        ...
        grpcStream.on('error', function (grpcError) {
            logDebug(LOG_TAG$9, 'GRPC stream error. Code:', grpcError.code, 'Message:', grpcError.message);
            var code = mapCodeFromRpcCode(grpcError.code);
