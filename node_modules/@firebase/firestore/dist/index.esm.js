...
import { XhrIo as y, EventType as m, ErrorCode as v, createWebChannelTransport as g, WebChannel as w } from "@firebase/webchannel-wrapper";
 ...
 */
/** The semver (www.semver.org) version of the SDK. */ var b = i.SDK_VERSION, T = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
...
T.i = new T("google-credentials-uid"), T.o = new T("first-party-uid");
...
var I = {
    ...
    function t(t) {
        ...
        this.currentUser = T.UNAUTHENTICATED, this.I = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.R !== e) throw new E(I.ABORTED, "getToken aborted due to token change.");
            return n ? (Ue("string" == typeof n.accessToken, "Invalid tokenData returned from getToken():" + n), 
    ...
    t.prototype.A = function() {
        ...
        return Ue(null === t || "string" == typeof t, "Received invalid UID: " + t), new T(t);
    }, t;
}(), S = /** @class */ function() {
    function t(t, e) {
        this.P = t, this.V = e, this.type = "FirstParty", this.user = T.o;
    }
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new E(I.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new E(I.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new E(I.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new E(I.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
...
var R = /** @class */ function() {
    ...
    n.G = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new E(I.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
var L = /^[_a-zA-Z][_a-zA-Z0-9]*$/, U = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.$ = function(t, e, r) {
    ...
    n.Z = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new E(I.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new E(I.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new E(I.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new E(I.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n;
}(R);
...
var P = /** @class */ function() {
    function t(t, e) {
        this.F = t, this.root = e || M.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.it = function(e, n) {
        return new t(this.F, this.root.it(e, n, this.F).rt(null, null, M.ot, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.F, this.root.remove(e, this.F).rt(null, null, M.ot, null, null));
    }, 
    ...
    t.prototype._t = function() {
        return new C(this.root, null, this.F, !1);
    }, t.prototype.lt = function(t) {
        return new C(this.root, t, this.F, !1);
    }, t.prototype.dt = function() {
        return new C(this.root, null, this.F, !0);
    }, t.prototype.ft = function(t) {
        return new C(this.root, t, this.F, !0);
    }, t;
}(), C = /** @class */ function() {
    function t(t, e, n, r) {
        this.Tt = r, this.Et = [];
    ...
    t.prototype.Dt = function() {
        ...
        var t = this.left.Dt();
        if (t !== this.right.Dt()) throw Le("Black depths differ");
...
var F = /** @class */ function() {
    function t(t) {
        this.F = t, this.data = new P(this.F);
    }
...
/** Extracts the backend's type order for the provided value. */ function X(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? Q(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : Le("Invalid value type: " + JSON.stringify(t));
}
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return n === r ? W(n) === W(r) : isNaN(n) && isNaN(r);
            }
            return !1;
        }(t, e);
...
function tt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = Pe(it(t.latitude), it(e.latitude));
            return 0 !== n ? n : Pe(it(t.longitude), it(e.longitude));
...
function et(t, e) {
    ...
    var n = rt(t), r = rt(e), i = Pe(n.seconds, r.seconds);
...
function rt(t) {
    ...
    if (Ue(!!t, "Cannot normalize null or undefined timestamp."), "string" == typeof t) {
        // The date string can have higher precision (nanos) than the Date class
        // (millis), so we do some custom parsing here.
        // Parse the nanos right out of the string.
        var e = 0, n = H.exec(t);
        if (Ue(!!n, "invalid timestamp: " + t), n[1]) {
...
/** Transforms an array value via a remove operation. */ function mt(t) {
...
/** A field path and the TransformOperation to perform upon it. */ bt.NONE = new bt;
...
var Tt = /** @class */ function() {
    ...
    return t(n, e), n.prototype.Ut = function(t, e) {
        this.Yt(t);
    ...
    n.prototype.ne = function(t) {
        var e;
        return e = t instanceof xt ? t.data() : St.EMPTY, this.ie(e);
    ...
    return t(n, e), n.prototype.Ut = function(t, e) {
        if (this.Yt(t), Ue(null != e.transformResults, "Transform results missing for TransformMutation."), 
        !this.Zt.Jt(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        ...
        for (var e = null, n = 0, r = this.fieldTransforms; n < r.length; n++) {
            var i = r[n], o = t instanceof xt ? t.field(i.field) : void 0, s = i.transform.qt(o || null);
    ...
    n.prototype.ae = function(t, e) {
        var n = [];
        Ue(this.fieldTransforms.length === e.length, "server transform result count (" + e.length + ") should match field transform count (" + this.fieldTransforms.length + ")");
        for (var r = 0; r < e.length; r++) {
            var i = this.fieldTransforms[r], o = i.transform, s = null;
            t instanceof xt && (s = t.field(i.field)), n.push(o.Ut(s, e[r]));
        }
        return n;
    }, 
    /**
    ...
    return t(n, e), n.prototype.Ut = function(t, e) {
        ...
        return this.Yt(t), this.Zt.Jt(t) ? new Rt(this.key, x.S()) : t;
    }, n.prototype.ee = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.key.isEqual(t.key) && this.Zt.isEqual(t.Zt);
    }, n;
}(Tt), _t = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
var Dt = /** @class */ function() {
    ...
    return t(n, e), n.prototype.field = function(t) {
        ...
        return null !== r && null !== i ? tt(r, i) : Le("Trying to compare documents on fields that don't exist");
    }, n;
    ...
    return t.ve = function(e) {
        ...
        get: function() {
            if (null === this.pe) {
                ...
                t.Y() ? this.pe = [ Yt ] : this.pe = [ new Wt(t), Yt ]; else {
                    this.pe = [];
                    ...
                    if (!n) {
                        ...
                        this.pe.push(s === Gt.ASCENDING ? Yt : Qt);
                    }
                }
            }
            return this.pe;
    ...
    t.prototype.canonicalId = function() {
        ...
        for (var t = 0, e = this.filters; t < e.length; t++) {
            var n = e[t];
            if (n instanceof Pt && n.Ge()) return n.field;
        }
        return null;
    }, 
    ...
    t.prototype.ze = function(t) {
        for (var e = 0, n = this.filters; e < n.length; e++) {
            var r = n[e];
            if (r instanceof Pt && t.indexOf(r.op) >= 0) return r.op;
        }
        return null;
    }, t.prototype.Pe = function() {
        return this.xe().Pe();
    ...
    t.prototype.xe = function() {
        ...
        var e = t.key.path;
        return null !== this.collectionGroup ? t.key.et(this.collectionGroup) && this.path.q(e) : O.st(this.path) ? this.path.isEqual(e) : this.path.W(e);
    }, 
    /**
...
var Pt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        if (t.Y()) return e === Ot.IN ? new Mt(t, r) : new Ct(t, e, r);
        if (ht(r)) {
            if (e !== Ot.EQUAL) throw new E(I.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (ct(r)) {
            if (e !== Ot.EQUAL) throw new E(I.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return e === Ot.ARRAY_CONTAINS ? new Ft(t, r) : e === Ot.IN ? new qt(t, r) : e === Ot.ARRAY_CONTAINS_ANY ? new jt(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && X(this.value) === X(e) && this.Ye(tt(e, this.value));
    ...
    return t(n, e), n.prototype.matches = function(t) {
        var e = O.F(t.key, this.key);
        return this.Ye(e);
    }, n;
}(Pt), Mt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
var Bt, zt, Kt = /** @class */ function() {
    ...
    t.prototype.Je = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? O.F(O.tt(o.referenceValue), e.key) : tt(o, e.field(i.field)), 
    ...
    return t.prototype.compare = function(t, e) {
        var n = this.Xe ? xt.Ee(t, e) : xt.Re(this.field, t, e);
        switch (this.dir) {
          case Gt.ASCENDING:
            return n;
...
}(), Yt = new Wt(U.X(), Gt.ASCENDING), Qt = new Wt(U.X(), Gt.DESCENDING), Jt = /** @class */ function() {
    function t(
 ...
 */ var ce = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.F = t ? function(e, n) {
            return t(e, n) || O.F(e.key, n.key);
        } : function(t, e) {
            return O.F(t.key, e.key);
        }, this.rs = re(), this.os = new P(this.F)
        /**
    ...
    return t.prototype.track = function(t) {
        ...
        // Metadata->Added
        // Removed->Metadata
        Le("unsupported combination of changes: " + JSON.stringify(t) + " after " + JSON.stringify(n)) : this.as = this.as.it(e, t);
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, de.Rs(e, n)), new t(x.MIN, r, he(), te(), ue());
    }, t;
}(), de = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.zs = function(t) {
        for (var e = 0, n = t.ps; e < n.length; e++) {
            var r = n[e];
            t.ys instanceof xt ? this.Hs(r, t.ys) : t.ys instanceof Rt && this.Js(r, t.key, t.ys);
        }
    ...
    t.prototype.sn = function(t) {
        ...
        if (r) {
            ...
            if (i.Pe()) if (0 === n) {
                ...
                // queries.
                var o = new O(i.path);
                this.Js(e, o, new Rt(o, x.S()));
            } else Ue(1 === n, "Single document existence filter with count: " + n); else this.in(e) !== n && (
    ...
    t.prototype.rn = function(t) {
        ...
        this.Ws.forEach((function(r, i) {
            ...
            if (o) {
                if (r.As && o.target.Pe()) {
                    ...
                    null !== e.js.get(s) || e.on(i, s) || e.Js(i, s, new Rt(s, t));
                }
        ...
        return this.js = te(), this.Ks = be(), this.Gs = new F(Pe), i;
    }, 
    /**
    ...
    t.prototype.Bs = function(t) {
        ...
        var e = this.Ks.get(t);
        return e || (e = new F(Pe), this.Ks = this.Ks.it(t, e)), e;
    }, 
    /**
    ...
    t.prototype.en = function(t) {
        var e = this;
        this.Ws.set(t, new ge), this.Qs.an(t).forEach((function(n) {
 ...
 */ var Ie = function() {
    ...
    return t.prototype._n = function(t) {
        var e = void 0 === t.code ? I.UNKNOWN : Zt(t.code);
     ...
     */
    t.prototype.Tn = function(t) {
        return Y(t) ? this.Wt(t) : this.jt(t);
    }, 
    /**
     ...
     */
    t.prototype.En = function(t) {
        return this.options.dn ? (Ue(void 0 === t || "string" == typeof t, "value must be undefined or a string when using proto3 Json"), 
        z.fromBase64String(t || "")) : (Ue(void 0 === t || t instanceof Uint8Array, "value must be undefined or Uint8Array"), 
        z.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.k(t.k());
    }, t.prototype.fromVersion = function(t) {
        return Ue(!!t, "Trying to deserialize version that isn't set"), x.v(this.v(t));
    }, t.prototype.wn = function(t, e) {
        return this.In(e || this.cn).child("documents").child(t).K();
    }, t.prototype.Rn = function(t) {
        var e = V.G(t);
        return Ue(Ae(e), "Tried to deserialize invalid key " + e.toString()), e;
    }, t.prototype.An = function(t) {
        return this.wn(t.path);
    }, t.prototype.tt = function(t) {
        var e = this.Rn(t);
        return Ue(e.get(1) === this.cn.projectId, "Tried to deserialize key from different project: " + e.get(1) + " vs " + this.cn.projectId), 
        Ue(!e.get(3) && !this.cn.database || e.get(3) === this.cn.database, "Tried to deserialize key from different database: " + e.get(3) + " vs " + this.cn.database), 
        new O(this.Pn(e));
        ...
        return Ue(t.length > 4 && "documents" === t.get(4), "tried to deserialize invalid key " + t.toString()), 
        t.M(5);
    }, 
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.yn = function(t, e) {
        ...
        Ue(!!t.found, "Tried to deserialize a found document from a missing document."), 
        ...
        Ue(!!t.missing, "Tried to deserialize a missing document from a found document."), 
        Ue(!!t.readTime, "Tried to deserialize a missing document without a read time.");
        var e = this.tt(t.missing), n = this.fromVersion(t.readTime);
        return new Rt(e, n);
    }, t.prototype.Cn = function(t) {
        return "found" in t ? this.Sn(t) : "missing" in t ? this.Dn(t) : Le("invalid batch get response: " + JSON.stringify(t));
        ...
        if ("targetChange" in t) {
            ...
            d.document;
            var y = this.tt(d.document), m = d.readTime ? this.fromVersion(d.readTime) : x.S(), v = new Rt(y, m), g = d.removedTargetIds || [];
            e = new ye([], g, v.key, v);
        } else if ("documentRemove" in t) {
            t.documentRemove;
            var w = t.documentRemove;
            w.document;
            var b = this.tt(w.document), T = w.removedTargetIds || [];
            e = new ye([], T, b, null);
        } else {
            ...
            var I = t.filter;
            I.targetId;
            var E = I.count || 0, N = new Ht(E), A = I.targetId;
            e = new me(A, N);
        }
        return e;
    }, t.prototype.Nn = function(t) {
        ...
        if (t instanceof It) e = {
            ...
            if (!(t instanceof _t)) return Le("Unknown mutation type " + t.type);
            e = {
        ...
        var e = this, n = t.currentDocument ? this.Bn(t.currentDocument) : bt.NONE;
        if (t.update) {
            t.update.name;
        ...
        if (t.transform) {
            ...
            return Ue(!0 === n.exists, 'Transforms only support precondition "exists == true"'), 
            new Nt(u, a);
        }
        if (t.verify) {
        ...
        var n = this;
        return t && t.length > 0 ? (Ue(void 0 !== e, "Received a write result without a commit time"), 
        t.map((function(t) {
            return n.Qn(t, e);
        }))) : [];
    }, t.prototype.Ln = function(t) {
        ...
        var e = null;
        if ("setToServerValue" in t) Ue("REQUEST_TIME" === t.setToServerValue, "Unknown server value transform proto: " + JSON.stringify(t)), 
        e = lt.instance; else if ("appendMissingElements" in t) {
            var n = t.appendMissingElements.values || [];
            e = new pt(n);
        } else if ("removeAllFromArray" in t) {
            var r = t.removeAllFromArray.values || [];
            e = new dt(r);
        } else "increment" in t ? e = new yt(this, t.increment) : Le("Unknown transform proto: " + JSON.stringify(t));
        ...
        Ue(1 === e, "DocumentsTarget contained other than 1 document: " + e);
        var n = t.documents[0];
        return Ut.ve(this.gn(n)).xe();
    }, t.prototype.Gn = function(t) {
        ...
        if (r > 0) {
            Ue(1 === r, "StructuredQuery.from with more than one collection is not supported.");
            var o = n.from[0];
        ...
        var c = null;
        return n.endAt && (c = this.ti(n.endAt)), new Ut(e, i, u, s, a, "F" /* First */ , h, c).xe();
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof Pt ? e.ni(t) : Le("Unrecognized filter: " + JSON.stringify(t));
            }));
    ...
    t.prototype.oi = function(t) {
        ...
        return new Wt(this.di(t.field), this.ui(t.direction));
    }, t.prototype.ri = function(t) {
        return Pt.create(this.di(t.fieldFilter.field), this._i(t.fieldFilter.op), t.fieldFilter.value);
    }, 
    // visible for testing
    t.prototype.ni = function(t) {
        ...
        switch (t.unaryFilter.op) {
          case "IS_NAN":
            ...
            return Pt.create(e, Ot.EQUAL, {
                doubleValue: NaN
            });

          case "IS_NULL":
            var n = this.di(t.unaryFilter.field);
            return Pt.create(n, Ot.EQUAL, {
...
function xe(t) {
    ...
    if (Se.logLevel <= s.DEBUG) {
        var i = e.map(Ve);
        Se.debug.apply(Se, r([ "Firestore (" + b + "): " + t ], i));
    }
}
...
function Re(t) {
    ...
    if (Se.logLevel <= s.ERROR) {
        var i = e.map(Ve);
        Se.error.apply(Se, r([ "Firestore (" + b + "): " + t ], i));
    }
}
...
function(t, e, n, r, i) {
    ...
    return t.from = function(e, n, r, i) {
        Ue(e.mutations.length === r.length, "Mutations sent " + e.mutations.length + " must equal results received " + r.length);
        for (var o = oe(), s = e.mutations, u = 0; u < s.length; u++) o = o.it(s[u].key, r[u].version);
     ...
     */
    t.prototype.Ni = function(t) {
        var e = this, n = O.EMPTY, r = new Ke(n, t), i = new Ke(n, t + 1), o = [];
        ...
        var e = O.EMPTY, n = new Ke(e, t), r = new Ke(e, t + 1), i = ue();
        return this.yi.Ct([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Mi = function(t) {
        var e = new Ke(t, 0), n = this.pi.Nt(e);
    ...
    return t.Ee = function(t, e) {
        return O.F(t.key, e.key) || Pe(t.Li, e.Li);
    }, 
    /** Compare by ID then by key */ t.bi = function(t, e) {
        return Pe(t.Li, e.Li) || O.F(t.key, e.key);
    }, t;
}(), We = /** @class */ function() {
    function t(t) {
        var e = this;
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Ui && Le("Called next() or catch() twice for PersistencePromise"), this.Ui = !0, 
    ...
    t.prototype.tr = function(t, e) {
        this.Xi();
        var n = this.zi.get(e);
        return void 0 !== n ? We.resolve(n) : this.er(t, e);
    }, 
    /**
    ...
    t;
}(), Qe = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Je = /** @class */ function() {
    function t() {
        this.ir = [];
    }
    ...
    t.prototype.wr = function(t, e, n) {
        ...
        return this.cr(t, new O(e)).next((function(t) {
            var e = re();
            return t instanceof xt && (e = e.it(t.key, t)), e;
        }));
    }, t.prototype.Rr = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = re();
        return this.ur.Pr(t, i).next((function(s) {
            return We.forEach(s, (function(s) {
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.gr(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    r = f instanceof xt ? r.it(h, f) : r.remove(h);
                }
            }));
        })).next((function() {
        ...
        for (var r = ue(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
            a instanceof Et && null === n.get(a.key) && (r = r.add(a.key));
        }
        var h = n;
        return this.hr.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof xt && (h = h.it(t, e));
            })), h;
        }));
    }, t;
}(), Xe = /** @class */ function() {
...
/** Represents the database ID a Firestore client is associated with. */ Ze.kr = -1;
...
var $e = function() {
    ...
    function t(t, e, n, r, i) {
        this.Nr = t, this.Fr = e, this.$r = n, this.op = r, this.Mr = i, this.Lr = new $e, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.xr && (this.clearTimeout(), this.Lr.reject(new E(I.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    t.prototype.enqueue = function(t) {
        ...
        var e = this, n = this.Qr.then((function() {
            return e.Gr = !0, t().catch((function(t) {
                ...
                throw e.Kr = t, e.Gr = !1, Re("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.Gr = !1, t;
            }));
    ...
    t.prototype.eo = function(t, e, n) {
        ...
        var i = tn.Or(this, t, e, n, (function(t) {
            return r.so(t);
        }));
 ...
 */ var rn = /** @class */ function() {
    function t(t) {
        this.ao = t, this.buffer = new F(nn), this.uo = 0;
    }
    return t.prototype.co = function() {
        ...
        if (this.buffer.size < this.ao) this.buffer = this.buffer.add(e); else {
            ...
            nn(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
...
sn.Po = -1, sn.Vo = 1048576, sn.po = 41943040, sn.Ro = 10, sn.Ao = 1e3, sn.yo = new sn(sn.po, sn.Ro, sn.Ao), 
sn.DISABLED = new sn(sn.Po, 0, 0);
...
var un = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        xe("LruGarbageCollector", "Garbage collection scheduled in " + n + "ms"), this.So = this.Nr.eo("lru_garbage_collection" /* LruGarbageCollection */ , n, (function() {
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.Lo = function(t, e) {
        var n = this;
        if (0 === e) return We.resolve(Ze.kr);
        var r = new rn(e);
    ...
    t.prototype.Bo = function(t, e) {
        ...
        var n = this;
        return this.Do.mo === sn.Po ? (xe("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        We.resolve(on)) : this.qo(t).next((function(r) {
            return r < n.Do.mo ? (xe("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.Do.mo), 
            on) : n.Qo(t, e);
        }));
        ...
        return this.$o(t, this.Do.Eo).next((function(e) {
            ...
            return e > c.Do.wo ? (xe("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + c.Do.wo + " from " + e), 
            r = c.Do.wo) : r = e, o = Date.now(), c.Lo(t, r);
        })).next((function(r) {
            return n = r, u = Date.now(), c.xo(t, n, e);
        })).next((function(e) {
            return i = e, a = Date.now(), c.Bo(t, n);
        })).next((function(t) {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.zo = x.MIN, this.persistence.Jo.Ho(this.jo), this.ar = t.Yo(n), this.Xo = t.Zo(), 
        this.th = t.eh(), this.sh = new He(this.Xo, this.ar, this.persistence.nh()), this.Wo.ih(this.sh)
    ...
    t.prototype.oh = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.ar, r = this.sh, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.ar.hh(n).next((function(s) {
                            return i = s, e = o.persistence.Yo(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new He(o.Xo, e, o.persistence.nh()), e.hh(n);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.ar = e, this.sh = r, this.Wo.ih(this.sh), 
                    i) ];
                }
            }));
        }));
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", (function(o) {
            return n.sh.Tr(o, i).next((function(i) {
                ...
                var s = [], u = 0, a = t; u < a.length; u++) {
                    ...
                    // exists=true
                    s.push(new Et(h.key, c, c.se(), bt.exists(!0)));
                }
    ...
    t.prototype.fh = function(t) {
        ...
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", (function(n) {
            return e.ar.Th(n, t).next((function(t) {
                return t ? e.sh.Tr(n, t) : We.resolve(null);
            }));
        }));
    }, 
    /**
    ...
    t.prototype.Ah = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.ar.Ph(n, t).next((function(t) {
                return Ue(null !== t, "Attempt to reject nonexistent batch!"), r = t.keys(), e.ar.Vh(n, t);
            })).next((function() {
                return e.ar.Rh(n);
            })).next((function() {
                return e.sh.Tr(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.Es.forEach((function(i, h) {
                    ...
                    a = a.it(i, h)) : xe("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", c.version, " Watch version:", h.version), 
    ...
    t.kh = function(t, e, n) {
        ...
        return Ue(e.resumeToken.Ot() > 0, "Attempted to persist target data with no resume token"), 
    ...
    t.prototype.Lh = function(t) {
        ...
        return this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(n) {
            return We.forEach(t, (function(t) {
                return We.forEach(t.yr, (function(t) {
    ...
    t.prototype.Uh = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.th.qh(n, t).next((function(i) {
                ...
                r = i, We.resolve(r)) : e.th.Qh(n).next((function(i) {
                    return r = new Jt(t, i, 0 /* Listen */ , n.Ch), e.th.Wh(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.qh = function(t, e) {
        var n = this.Go.get(e);
        return void 0 !== n ? We.resolve(this.Ko.get(n)) : this.th.qh(t, e);
    }, 
    /**
    ...
    t.prototype.jh = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(i) {
            ...
            var o = n.jo.Ni(t);
            return e ? We.resolve() : We.forEach(o, (function(t) {
    ...
    t.prototype.Kh = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.qh(o, t.xe()).next((function(t) {
                ...
                return n.Wo.wr(o, t, e ? r : x.MIN, e ? i : ue());
            })).next((function(t) {
                return {
                    documents: t,
                    zh: i
    ...
    t.prototype.Zh = function(t) {
        ...
        var r = this, i = e.batch, o = i.keys(), s = We.resolve();
        return o.forEach((function(r) {
            s = s.next((function() {
                return n.tr(t, r);
            })).next((function(t) {
                var o = t, s = e.gi.get(r);
                Ue(null !== s, "ackVersions should contain every doc in the write."), (!o || o.version.D(s) < 0) && ((o = i.Ut(r, o, e)) && 
...
function cn(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== I.FAILED_PRECONDITION || t.message !== Qe) throw t;
 ...
 */ function fn(t, e) {
    if (0 !== e.length) throw new E(I.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + Dn(e.length, "argument") + ".");
}
 ...
 */ function ln(t, e, n) {
    if (e.length !== n) throw new E(I.INVALID_ARGUMENT, "Function " + t + "() requires " + Dn(n, "argument") + ", but was called with " + Dn(e.length, "argument") + ".");
}
 ...
 */ function pn(t, e, n) {
    if (e.length < n) throw new E(I.INVALID_ARGUMENT, "Function " + t + "() requires at least " + Dn(n, "argument") + ", but was called with " + Dn(e.length, "argument") + ".");
}
 ...
 */ function dn(t, e, n, r) {
    if (e.length < n || e.length > r) throw new E(I.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + Dn(e.length, "argument") + ".");
}
...
function wn(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = In(r);
        throw new E(I.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
 ...
 */
/** Helper to validate the type of a provided input. */ function bn(t, e, n, r) {
    if (!("object" === e ? Tn(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = In(r);
        throw new E(I.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
/** Returns a string describing the type / value of the provided input. */ function In(t) {
...
function En(t, e, n) {
    if (void 0 === n) throw new E(I.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + Sn(e) + " argument, but it was undefined.");
}
 ...
 */ function Nn(t, e, n) {
    G(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new E(I.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function An(t, e, n, r) {
    var i = In(r);
    return new E(I.INVALID_ARGUMENT, "Function " + t + "() requires its " + Sn(n) + " argument to be a " + e + ", but it was: " + i);
}

function _n(t, e, n) {
    if (n <= 0) throw new E(I.INVALID_ARGUMENT, 'Function "' + t + '()" requires its ' + Sn(e) + " argument to be a positive number, but it was: " + n + ".");
}
 ...
 */ function kn(t, e) {
    function n() {
        ...
        throw e && (t += " ", t += e), new E(I.INVALID_ARGUMENT, t);
    }
...
function xn() {
    if ("undefined" == typeof Uint8Array) throw new E(I.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function Rn() {
    if (!_e.Lt().ia) throw new E(I.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
...
var Vn = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ln("Blob.fromBase64String", arguments, 1), yn("Blob.fromBase64String", "string", 1, e), 
        Rn();
        try {
            return new t(z.fromBase64String(e));
        } catch (e) {
            throw new E(I.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
        if (ln("Blob.fromUint8Array", arguments, 1), xn(), !(e instanceof Uint8Array)) throw An("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(z.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return ln("Blob.toBase64", arguments, 0), Rn(), this.ra.toBase64();
    }, t.prototype.toUint8Array = function() {
        return ln("Blob.toUint8Array", arguments, 0), xn(), this.ra.toUint8Array();
    }, t.prototype.toString = function() {
        return "Blob(base64: " + this.toBase64() + ")";
    }, t.prototype.isEqual = function(t) {
        return this.ra.isEqual(t.ra);
    }, t;
}(), Ln = kn(Vn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), Un = /** @class */ function() {
    /**
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new E(I.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + Dn(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (yn("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new E(I.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.oa = new U(t);
    }
    return t.documentId = function() {
        return t.ha;
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw An("isEqual", "FieldPath", 1, e);
 ...
 */
var On = new RegExp("[~\\*/\\[\\]]"), Pn = /** @class */ function() {
    function t(t) {
        this.aa = t;
    }
    return t.delete = function() {
        return fn("FieldValue.delete", arguments), Cn.instance;
    }, t.serverTimestamp = function() {
        return fn("FieldValue.serverTimestamp", arguments), Mn.instance;
    }, t.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return pn("FieldValue.arrayUnion", arguments, 1), new Fn(t);
    }, t.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return pn("FieldValue.arrayRemove", arguments, 1), new qn(t);
    }, t.increment = function(t) {
        return yn("FieldValue.increment", "number", 1, t), ln("FieldValue.increment", arguments, 1), 
        new jn(t);
    }, t.prototype.isEqual = function(t) {
        return this === t;
    }, t;
 ...
 */
/** Singleton instance. */ Cn.instance = new Cn;
...
/** Singleton instance. */ Mn.instance = new Mn;

var Fn = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayUnion") || this).ua = t, n;
    }
    return t(n, e), n;
}(Pn), qn = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayRemove") || this).ua = t, n;
    }
    return t(n, e), n;
}(Pn), jn = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.increment") || this).ca = t, n;
    }
    return t(n, e), n;
}(Pn), Gn = kn(Pn, "Use FieldValue.<field>() instead."), Bn = /** @class */ function() {
    function t(t, e) {
        if (ln("GeoPoint", arguments, 2), yn("GeoPoint", "number", 1, t), yn("GeoPoint", "number", 2, e), 
        !isFinite(t) || t < -90 || t > 90) throw new E(I.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new E(I.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this._a = t, this.la = e;
    }
     ...
     */
    t.prototype.p = function(t) {
        return Pe(this._a, t._a) || Pe(this.la, t.la);
    }, t;
}(), zn = /^__.*__$/, Kn = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.se = e, this.fieldTransforms = n;
    }
    return t.prototype.da = function(t, e) {
        var n = [];
        return null !== this.se ? n.push(new Et(t, this.data, this.se, e)) : n.push(new It(t, this.data, e)), 
    ...
    return t.prototype.da = function(t, e) {
        var n = [ new Et(t, this.data, this.se, e) ];
...
/** A "context" object passed around while parsing user data. */ var Qn = /** @class */ function() {
    /**
    ...
    return t.prototype.Ea = function(e) {
        ...
        return new E(I.INVALID_ARGUMENT, "Function " + this.methodName + "() called with invalid data. " + t + e);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Yn(this.fa) && zn.test(t)) throw this.Aa('Document fields cannot begin and end with "__"');
    }, t;
}(), Jn = function(t, e) {
    ...
    return t.prototype.Va = function(t, e) {
        var n = new Qn(0 /* Set */ , t, U.H);
        Zn("Data must be an object, but it was:", n, e);
        var r = this.ga(e, n);
        return new Kn(new St(r), 
        /* fieldMask= */ null, n.fieldTransforms);
    }, 
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.pa = function(t, e, n) {
        var r = new Qn(2 /* MergeSet */ , t, U.H);
        Zn("Data must be an object, but it was:", r, e);
        var i, o, s = this.ga(e, r);
        if (n) {
            for (var u = new F(U.F), a = 0, h = n; a < h.length; a++) {
                var c = h[a], f = void 0;
                if (c instanceof Un) f = c.oa; else {
                    if ("string" != typeof c) throw Le("Expected stringOrFieldPath to be a string or a FieldPath");
                    f = tr(t, c);
                }
                if (!r.contains(f)) throw new E(I.INVALID_ARGUMENT, "Field '" + f + "' is specified in your field mask but missing from your input data.");
                u = u.add(f);
            }
            i = vt.Kt(u), o = r.fieldTransforms.filter((function(t) {
                return i.zt(t.field);
            }));
        } else i = vt.Gt(r.se), o = r.fieldTransforms;
        return new Kn(new St(s), i, o);
    }, 
    /** Parse update data from an update() call. */ t.prototype.ya = function(t, e) {
        var n = this, r = new Qn(1 /* Update */ , t, U.H);
        Zn("Data must be an object, but it was:", r, e);
        var i = new F(U.F), o = St._e();
        G(e, (function(e, s) {
            var u = tr(t, e), a = r.Ia(u);
            if ((s = n.ba(s, a)) instanceof Cn) 
        ...
        var s = vt.Kt(i);
        return new Wn(o.oe(), s, r.fieldTransforms);
    }, 
    /** Parse update data from a list of field/value arguments. */ t.prototype.Sa = function(t, e, n, r) {
        var i = new Qn(1 /* Update */ , t, U.H), o = [ $n(t, e) ], s = [ n ];
        if (r.length % 2 != 0) throw new E(I.INVALID_ARGUMENT, "Function " + t + "() needs to be called with an even number of arguments that alternate between field names and values.");
        for (var u = 0; u < r.length; u += 2) o.push($n(t, r[u])), s.push(r[u + 1]);
        for (var a = new F(U.F), h = St._e(), c = 0; c < o.length; ++c) {
            var f = o[c], l = i.Ia(f), p = this.ba(s[c], l);
            if (p instanceof Cn) 
            // Add it to the field mask, but don't add anything to updateData.
            a = a.add(f); else {
                var d = this.va(p, l);
        ...
        var y = vt.Kt(a);
        return new Wn(h.oe(), y, i.fieldTransforms);
    }, 
    /**
    ...
    t.prototype.Da = function(t, e, n) {
        void 0 === n && (n = !1);
        var r = new Qn(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t, U.H);
        return this.va(e, r);
    }, 
    ...
    t.prototype.va = function(t, e) {
        if (Xn(t = this.ba(t, e))) return Zn("Unsupported field value:", e, t), this.ga(t, e);
        if (t instanceof Pn) 
    ...
    t.prototype.Ca = function(t, e) {
        ...
        if (!Yn(e.fa)) throw e.Aa(t.aa + "() can only be used with update() and set()");
        ...
        if (t instanceof Cn) {
            ...
            // fieldMask so it gets deleted.
                        e.se.push(e.path);
        } else if (t instanceof Mn) e.fieldTransforms.push(new gt(e.path, lt.instance)); else if (t instanceof Fn) {
            var n = this.Fa(t.aa, t.ua), r = new pt(n);
            e.fieldTransforms.push(new gt(e.path, r));
        } else if (t instanceof qn) {
            var i = this.Fa(t.aa, t.ua), o = new dt(i);
            e.fieldTransforms.push(new gt(e.path, o));
        } else if (t instanceof jn) {
            var s = this.Da("FieldValue.increment", t.ca), u = new yt(this.serializer, s);
    ...
    t.prototype.Na = function(t, e) {
        ...
        throw e.Aa("Unsupported field value: " + In(t));
 ...
 */
function Xn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof k || t instanceof Bn || t instanceof Vn || t instanceof Jn || t instanceof Pn);
}
 ...
 */ function $n(t, e) {
    if (e instanceof Un) return e.oa;
    if ("string" == typeof e) return tr(t, e);
    throw new E(I.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. Field path arguments must be of type string or FieldPath.");
}
 ...
 */ function tr(t, e) {
    try {
        return function(t) {
            if (t.search(On) >= 0) throw new E(I.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (Un.bind.apply(Un, r([ void 0 ], t.split("."))));
            } catch (e) {
                throw new E(I.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).oa;
    } catch (e) {
        var n = er(e);
        throw new E(I.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. " + n);
    }
}
 ...
 */ var nr = /** @class */ function() {
    ...
    t.prototype.Qa = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                this.xa > 0 && xe("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.xa + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.za = 0, this.Ha = null, this.stream = null, this.Ja = new nr(t, e)
        /**
    ...
    t.prototype.ru = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new E(I.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.uu(e);
            }));
        }));
    ...
    t.prototype.hu = function(t) {
        ...
        return function(n) {
            e.$a.qr((function() {
                return e.za === t ? n() : (xe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.cu = function(t) {
    ...
    return t(n, e), Object.defineProperty(n.prototype, "Eu", {
        /**
    ...
    n.prototype.start = function() {
        this.mu = !1, e.prototype.start.call(this);
        ...
        Ue(!!t.streamToken, "Got a write response without a stream token"), this.lastStreamToken = this.serializer.En(t.streamToken), 
        this.mu) {
        ...
        // The first response is always the handshake response
                return Ue(!t.writeResults || 0 === t.writeResults.length, "Got mutation results for handshake"), 
...
}(rr), sr = /** @class */ function() {
    function t(t, e, n, r) {
        this.$a = t, this.Ka = e, this.credentials = n, this.serializer = r;
    }
    return t.prototype.Pu = function(t) {
        return new or(this.$a, this.Ka, this.credentials, this.serializer, t);
    }, t.prototype.Vu = function(t) {
        return new ir(this.$a, this.Ka, this.credentials, this.serializer, t);
        ...
        return this.yu("BatchGetDocuments", n).then((function(n) {
            ...
            return t.forEach((function(t) {
                var e = r.get(t);
                Ue(!!e, "Missing entity in write response for " + t), i.push(e);
            })), i;
        }));
    }, 
    ...
    function t(t) {
        ...
        this.vu = oe(), this.mutations = [], this.Su = !1, 
        /**
    ...
    return t.prototype.pu = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.ku(), this.mutations.length > 0) throw new E(I.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , this.bu.pu(t) ];

                  case 1:
                    return [ 2 /*return*/ , ((e = n.sent()).forEach((function(t) {
                        t instanceof Rt || t instanceof xt ? r.Nu(t) : Le("Document in a transaction was a " + t.constructor.name);
                    })), e) ];
                }
            }));
        }));
        ...
        this.write([ new At(t, this.Zt(t)) ]), this.Cu.add(t);
                ...
                switch (n.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        e.mutations.push(new _t(t, e.Zt(t)));
                    })), [ 4 /*yield*/ , this.bu.commit(this.mutations) ];

                  case 1:
                    // For each mutation, note that the doc was written.
                    return n.sent(), this.Su = !0, [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        if (null !== n) {
            ...
            throw new E(I.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.Zt = function(t) {
        var e = this.vu.get(t);
        return !this.Cu.has(t) && e ? bt.updateTime(e) : bt.NONE;
    }, 
    /**
    ...
    t.prototype.Fu = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new E(I.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    t.prototype.set = function(t) {
        ...
        this.Ou ? (Re(e), this.Ou = !1) : xe("OnlineStateTracker", e);
    ...
    r, i, o, s) {
        ...
        /**
             ...
             */
        this.networkEnabled = !1, this.isPrimary = !1, this.zu = s, this.zu.Hu((function(t) {
            i.qr((function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.Ju() ? (xe("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.ju.length > 0 && (xe("RemoteStore", "Stopping write stream with " + this.ju.length + " pending writes"), 
    ...
    t.prototype.Tc = function(t) {
        ...
        this.Gu = new we(this), this.Zu.start(), this.Xu.xu();
    }, 
    /**
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    return this.Xu.set("Online" /* Online */), t instanceof ve && 2 /* Removed */ === t.state && t.cause ? [ 2 /*return*/ , this.Ec(t) ] : (t instanceof ye ? this.Gu.zs(t) : t instanceof me ? this.Gu.sn(t) : this.Gu.Ys(t), 
                    r.isEqual(x.MIN) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.Wu.bh() ]);

                  case 1:
                    return e = n.sent(), r.D(e) >= 0 ? [ 4 /*yield*/ , this.wc(r) ] : [ 3 /*break*/ , 3 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return null !== (e = n.sent()) ? [ 3 /*break*/ , 2 ] : (0 === this.ju.length && this.nc.eu(), 
                    [ 3 /*break*/ , 4 ]);

                  case 2:
                    return this.Ac(e), [ 4 /*yield*/ , this.uc() ];
    ...
    t.prototype.Ac = function(t) {
        ...
        var n = this, r = this.ju.shift(), i = Be.from(r, t, e, this.nc.lastStreamToken);
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                return t && this.ju.length > 0 ? [ 2 /*return*/ , (e = this.nc.Eu ? this.yc(t) : this.bc(t), 
                e.then((function() {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                ...
                return Xt(t.code) ? [ 2 /*return*/ , (xe("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.nc.lastStreamToken), 
                this.nc.lastStreamToken = z.xt, this.Wu.yh(z.xt).catch(cn)) ] : [ 2 /*return*/ ];
            }));
        }));
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                // logic kick in.
                return Xt(r = t.code) && r !== I.ABORTED ? (e = this.ju.shift(), [ 2 /*return*/ , (this.nc.tu(), 
                this.mc.vc(e.batchId, t).then((function() {
                    return i.uc();
                }))) ]) : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Sc = function() {
        return new ur(this.bu);
            ...
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    xe("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.Yu() ]) : [ 3 /*break*/ , 2 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return (e = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.cc() ];

                  case 3:
                    n.sent(), e = this.Xu.set("Unknown" /* Unknown */), n.label = 4;
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function fr(t, e, n) {
...
var pr = /** @class */ function() {
    ...
    return t.kc = function(e, n, r) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (s = new E(i.error.code, i.error.message))), 
    ...
    return t.kc = function(e, n) {
        ...
        return i && r.error && ((i = "string" == typeof r.error.message && "string" == typeof r.error.code) && (o = new E(r.error.code, r.error.message))), 
    ...
    return t.kc = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = he(), s = 0; i && s < r.activeTargetIds.length; ++s) i = Y(r.activeTargetIds[s]), 
    ...
    function t(e, n, r, i, o) {
        ...
        /**
             ...
             */
        this.Bc = [], !t.Uc(this.platform)) throw new E(I.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
        // Escape the special characters mentioned here:
        // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions
                var s = r.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.platform.window.localStorage, this.currentUser = o, this.qc = cr(this.persistenceKey, this.Mc), 
        this.Qc = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.Lc[this.Mc] = new vr, this.Wc = new RegExp("^firestore_clients_" + s + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.Uc = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.Mc && (o = this.getItem(cr(this.persistenceKey, i))) && (s = yr.kc(i, o)) && (this.Lc[s.clientId] = s);
        ...
        // by another tab
                if (this.Xc(t)) {
            var n = this.storage.getItem(lr(this.persistenceKey, t));
            if (n) {
                var r = dr.kc(t, n);
                r && (e = r.state);
            }
        ...
        if (t.storageArea === this.storage) {
            if (xe("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.qc) return void Re("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.$a.qr((function() {
                return e(r, void 0, void 0, (function() {
                    var e, r, i, o, s, u;
                    return n(this, (function(n) {
                        if (this.ko) {
                            if (null !== t.key) if (this.Wc.test(t.key)) {
                                if (null == t.newValue) return e = this.l_(t.key), [ 2 /*return*/ , this.d_(e, null) ];
                                ...
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                    Ue("number" == typeof n, "Found non-numeric sequence number"), e = n;
                                } catch (t) {
                                    Re("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
                            }(t.newValue)) !== Ze.kr && this.vr(u);
                        } else this.Bc.push(t);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new pr(this.currentUser, t, e, n), i = fr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Nc());
    }, t.prototype.s_ = function(t) {
        var e = fr(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = lr(this.persistenceKey, t), i = new dr(t, e, n);
        this.setItem(r, i.Nc());
    }, 
    /**
    ...
    t.prototype.Hc = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.mc.I_(t.batchId, t.state, t.error) ] : (xe("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
    }, t.prototype.w_ = function(t) {
        return this.mc.R_(t.targetId, t.state, t.error);
    }, t.prototype.d_ = function(t, r) {
        var i = this, o = this.Yc();
        r ? this.Lc[t] = r : delete this.Lc[t];
        var s = this.Yc(), u = [], a = [];
        return s.forEach((function(t) {
            ...
            return e(i, void 0, void 0, (function() {
                return n(this, (function(e) {
                    return s.has(t) || a.push(t), [ 2 /*return*/ ];
                }));
            }));
        })), this.mc.A_(u, a);
    ...
    function t() {
        this.P_ = new vr, this.V_ = {}, this.mc = null, this.$u = null, this.vr = null;
    }
    return t.prototype.Zc = function(t) {
        ...
        return this.P_ = new vr, Promise.resolve();
    }, t.prototype.oh = function(t, e, n) {
        // No op.
    }, t.prototype.c_ = function(t) {
        // No op.
    ...
    e) {
        ...
        this._s = ue(), this.D_ = new ce(t.Be.bind(t));
    }
    ...
    t.prototype.k_ = function(t, e) {
        var n = this, r = e ? e.N_ : new fe, i = e ? e.D_ : this.D_, o = e ? e._s : this._s, s = i, u = !1, a = this.query.je() && i.size === this.query.limit ? i.last() : null, h = this.query.Ke() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.nr = function(t, e, n) {
        ...
        return this.v_ = u, 0 !== o.length || a ? {
            snapshot: new le(this.query, t.D_, i, o, t._s, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            x_: s
        } : {
            x_: s
    ...
    t.prototype.L_ = function(t) {
        ...
        // updating many documents.
                var e = this.S_;
        this.S_ = ue(), this.D_.forEach((function(e) {
            t.U_(e.key) && (t.S_ = t.S_.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.S_.has(e) || n.push(new Ir(e));
    ...
    t.prototype.Q_ = function() {
        return le.fs(this.query, this.D_, this._s, 0 /* Local */ === this.v_);
    }, t;
}(), Nr = /** @class */ function() {
    function t(t, e, n, r) {
        this.Nr = t, this.W_ = e, this.updateFunction = n, this.Lr = r, this.j_ = 5, this.Ja = new nr(this.Nr, "retry_transaction" /* RetryTransaction */)
    ...
    return t.prototype.K_ = function() {
        ...
        this.Ja.Qa((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = this.W_.Sc(), (e = this.z_(t)) && e.then((function(e) {
                        r.Nr.qr((function() {
        ...
        try {
            ...
            return !K(e) && e.catch && e.then ? e : (this.Lr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    n, r, i) {
        ...
        /**
             ...
             */
        this.rl = new Map, this.ol = new ze, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.hl = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.al = new Map, this.ul = br.y_(), 
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    e = i.targetId, this.X_.n_(e), r = i.view.Q_(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.Wu.Uh(t.xe()) ];

                  case 2:
                    return o = n.sent(), s = this.X_.n_(o.targetId), e = o.targetId, [ 4 /*yield*/ , this.ll(t, e, "current" === s) ];

                  case 3:
                    r = n.sent(), this.isPrimary && this.W_.listen(o), n.label = 4;

                  case 4:
                    return [ 2 /*return*/ , (this.tl.du([ r ]), e) ];
                }
            }));
        }));
    }, 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), o = new Er(t, e.zh), s = o.k_(e.documents), u = de.Rs(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.nr(s, 
                    /* updateLimboDocuments= */ !0 === this.isPrimary, u), h = new Ar(t, r, o), [ 2 /*return*/ , (this.el.set(t, h), 
                    this.sl.has(r) ? this.sl.get(r).push(t) : this.sl.set(r, [ t ]), a.snapshot) ];
                }
            }));
        }));
    }, 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), r = t.view.q_(e), [ 2 /*return*/ , (this.isPrimary && this.fl(t.targetId, r.x_), 
                    r) ];
                }
            }));
        }));
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // to the target.
                    return this._l("unlisten()"), e = this.el.get(t), (r = this.sl.get(e.targetId)).length > 1 ? [ 2 /*return*/ , (this.sl.set(e.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.el.delete(t)) ] : this.isPrimary ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.X_.r_(e.targetId), this.X_.Xc(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.Wu.jh(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.X_.h_(e.targetId), i.W_.fc(e.targetId), i.Tl(e.targetId);
                    })).catch(cn) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.Tl(e.targetId), [ 4 /*yield*/ , this.Wu.jh(e.targetId, 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), this.X_.Zc(e.batchId), this.ml(e.batchId, r), [ 4 /*yield*/ , this.El(e.zi) ];

                  case 2:
                    return n.sent(), [ 4 /*yield*/ , this.W_.uc() ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this._l("applyRemoteEvent()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Wu.vh(t) ];
                  ...
                  case 2:
                    ...
                    t.Ts.forEach((function(t, e) {
                        ...
                        Ue(t.Ps.size + t.Vs.size + t.gs.size <= 1, "Limbo resolution for single document contains multiple changes."), 
                        t.Ps.size > 0 ? n.Y_ = !0 : t.Vs.size > 0 ? Ue(n.Y_, "Received change for limbo target document without add.") : t.gs.size > 0 && (Ue(n.Y_, "Received remove for limbo target document without add."), 
                        n.Y_ = !1));
                    })), [ 4 /*yield*/ , this.El(e, t) ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.X_.a_(t, "rejected", r), e = this.rl.get(t), (i = e && e.key) ? (
                    // Since this query failed, we won't want to manually unlisten to it.
                    // So go ahead and remove it from bookkeeping.
                    this.il = this.il.remove(i), this.rl.delete(t), this.Il(), o = (o = new P(O.F)).it(i, new Rt(i, x.S())), 
                    s = ue().add(i), u = new pe(x.MIN, 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new F(Pe), o, s), [ 2 /*return*/ , this.vh(u) ]) : [ 4 /*yield*/ , this.Wu.jh(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.Tl(t, r);
                    })).catch(cn) ];
    ...
    t.prototype.I_ = function(t, r, i) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return null === (e = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== r ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.W_.uc() ];
                  ...
                  case 3:
                    ...
                    // other clients.
                    this.Rl(t, i || null), this.Wu.Yh(t)) : Le("Unknown batchState: " + r), n.label = 4;

                  case 4:
                    return [ 4 /*yield*/ , this.El(e) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this._l("applySuccessfulWrite()"), e = t.batch.batchId, 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught
                    // up), so we raise user callbacks first so that they consistently happen
                    // before listen events.
                    this.Rl(e, /*error=*/ null), this.Al(e), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Wu.mh(t) ];

                  case 2:
                    return r = n.sent(), this.X_.e_(e, "acknowledged"), [ 4 /*yield*/ , this.El(r) ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // listen events.
                    this.Rl(t, r), this.Al(t), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Wu.Ah(t) ];

                  case 2:
                    return e = n.sent(), this.X_.e_(t, "rejected", r), [ 4 /*yield*/ , this.El(e) ];
    ...
    t.prototype.Pl = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.W_.Ju() || xe("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    [ 4 /*yield*/ , this.Wu.gh() ];

                  case 1:
                    return -1 === (e = n.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.al.get(e) || []).push(t), 
                    this.al.set(e, r), [ 2 /*return*/ ]);
                }
            }));
        }));
    }, 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Vl = function(t) {
        this.al.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new E(I.CANCELLED, t));
            }));
        })), this.al.clear();
    }, t.prototype.ml = function(t, e) {
        var n = this.hl[this.currentUser.s()];
        n || (n = new P(Pe)), n = n.it(t, e), this.hl[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Rl = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Tr ? (this.ol.vi(i.key, t), this.yl(i)) : i instanceof Ir ? (xe("SyncEngine", "Document no longer in limbo: " + i.key), 
            this.ol.Di(i.key, t), this.ol.Mi(i.key) || 
            // We removed the last reference for this key
            this.pl(i.key)) : Le("Unknown limbo change: " + JSON.stringify(i));
        }
    }, t.prototype.yl = function(t) {
        var e = t.key;
        this.il.get(e) || (xe("SyncEngine", "New document in limbo: " + e), this.nl.push(e), 
        this.Il());
    }, 
    /**
    ...
    t.prototype.Il = function() {
        for (;this.nl.length > 0 && this.il.size < this.Z_; ) {
            ...
            this.rl.set(e, new _r(t)), this.il = this.il.it(t, e), this.W_.listen(new Jt(Ut.ve(t.path).xe(), e, 2 /* LimboResolution */ , Ze.kr));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.vl = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.el.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var n = r && r.Ts.get(u.targetId), o = u.view.nr(t, 
                  ...
                  case 1:
                    return n.sent(), this.tl.du(e), [ 4 /*yield*/ , this.Wu.Lh(i) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), e = this.X_.Yc(), [ 4 /*yield*/ , this.Sl(e.j()) ];

                  case 2:
                    for (r = n.sent(), i = 0, o = r; i < o.length; i++) s = o[i], this.W_.listen(s);
                    return [ 3 /*break*/ , 7 ];
                  ...
                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.Sl(u) ];

                  case 5:
                    return n.sent(), this.Dl(), [ 4 /*yield*/ , this.W_.Cc(!1) ];
    ...
    t.prototype.Dl = function() {
        ...
        this.rl.forEach((function(e, n) {
            t.W_.fc(n);
        })), this.ol.Fi(), this.rl = new Map, this.il = new P(O.F);
    }, 
    /**
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    return n.sent(), [ 4 /*yield*/ , this.Wu.Uh(a[0].xe()) ];
                  ...
                  case 9:
                    return d = n.sent(), [ 4 /*yield*/ , this.Wu.Uh(d) ];

                  case 10:
                    return u = n.sent(), [ 4 /*yield*/ , this.ll(this.Cl(d), s, 
                    /*current=*/ !1) ];
    ...
    t.prototype.Cl = function(t) {
        return new Ut(t.path, t.collectionGroup, t.orderBy, t.filters, t.limit, "F" /* First */ , t.startAt, t.endAt);
    }, 
    // PORTING NOTE: Multi-tab only
    t.prototype.Jh = function() {
        return this.Wu.Jh();
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    return e = n.sent(), o = pe.Is(t, "current" === r), [ 4 /*yield*/ , this.El(e, o) ];
                  ...
                  case 6:
                    return n.sent(), this.Tl(t, i), [ 3 /*break*/ , 8 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(d) {
                switch (d.label) {
                  ...
                  case 1:
                    return e < i.length ? (o = i[e], [ 4 /*yield*/ , this.Wu.ta(o) ]) : [ 3 /*break*/ , 6 ];
    ...
    t.prototype.disableNetwork = function() {
        ...
        var e = this.rl.get(t);
        if (e && e.Y_) return ue().add(e.key);
        var n = ue(), r = this.sl.get(t);
        if (!r) return n;
    ...
    return t.prototype.listen = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            var e, r, i, o;
            return n(this, (function(n) {
                return e = t.query, r = !1, (i = this.Fl.get(e)) && (o = i.Nl.indexOf(t)) >= 0 && (i.Nl.splice(o, 1), 
                r = 0 === i.Nl.length), r ? [ 2 /*return*/ , (this.Fl.delete(e), this.mc.fc(e)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.B_ = function(t) {
        ...
        t = le.fs(t.query, t.docs, t._s, t.fromCache), this.Ul = !0, this.Bl.next(t);
    }, t;
}(), Rr = /** @class */ function() {
    function t() {}
    return t.prototype.ih = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.Oe() || n.isEqual(x.MIN) ? this.zl(t, e) : this.Gl.Tr(t, r).next((function(o) {
            var u = i.Hl(e, o);
            return (e.je() || e.Ke()) && i.M_(e.ge, u, r, n) ? i.zl(t, e) : (De() <= s.DEBUG && xe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            i.Gl.wr(t, e, n).next((function(t) {
 ...
 */
function Vr(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = Ur(e)), e = Lr(t.get(n), e);
    return Ur(e);
}

/** Encodes a single segment of a resource path into the given result */ function Lr(t, e) {
 ...
 */ function Or(t) {
    ...
    var e = t.length;
    if (Ue(e >= 2, "Invalid path " + t), 2 === e) return Ue("" === t.charAt(0) && "" === t.charAt(1), "Non-empty path " + t + " had length 2"), 
    V.H;
    ...
    // source value.
        ...
        var s = t.indexOf("", o);
        switch ((s < 0 || s > n) && Le('Invalid encoded resource path: "' + t + '"'), t.charAt(s + 1)) {
          case "":
          ...
          default:
            Le('Invalid encoded resource path: "' + t + '"');
        }
        o = s + 2;
    }
    return new V(r);
 ...
 */ var Pr = /** @class */ function() {
    function t(e) {
        ...
        // log on 12.2.
        12.2 === t.Jl(u()) && Re("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.")
        /**
    ...
    return t.Yl = function(e, n, r) {
        return xe("SimpleDb", "Opening database:", e), new We((function(i, o) {
            ...
            s.onsuccess = function(e) {
                ...
                o(new E(I.FAILED_PRECONDITION, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
            }, s.onerror = function(t) {
                var e = t.target.error;
                "VersionError" === e.name ? o(new E(I.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : o(e);
            }, s.onupgradeneeded = function(t) {
                xe("SimpleDb", 'Database "' + e + '" requires upgrade from version:', t.oldVersion);
                var n = t.target.result;
                r.createOrUpgrade(n, s.transaction, t.oldVersion, ui).next((function() {
                    xe("SimpleDb", "Database upgrade to version " + ui + " complete");
                }));
            };
        })).Wi();
    }, 
    /** Deletes the specified database. */ t.delete = function(t) {
        return xe("SimpleDb", "Removing database:", t), qr(window.indexedDB.deleteDatabase(t)).Wi();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.Uc = function() {
        ...
        // Check the UA string to find out the browser.
                var e = u(), n = t.Jl(e), r = 0 < n && n < 10, i = t.Zl(e), o = 0 < i && i < 4.5;
        // IE 10
                  ...
                  case 0:
                    e = "readonly" === t, o = 0, s = function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                ++o, t = Mr.open(u.db, e ? "readonly" : "readwrite", r), n.label = 1;
    ...
    function t(t) {
        ...
        /**
             ...
             */
        this._d = new $e, this.transaction.oncomplete = function() {
            e._d.resolve();
        }, this.transaction.onabort = function() {
            t.error ? e._d.reject(t.error) : e._d.resolve();
        }, this.transaction.onerror = function(t) {
            var n = Gr(t.target.error);
            e._d.reject(n);
        };
    }
    return t.open = function(e, n, r) {
        ...
        t && this._d.reject(t), this.aborted || (xe("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    t.prototype.add = function(t) {
        return xe("SimpleDb", "ADD", this.store.name, t, t), qr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return xe("SimpleDb", "DELETE", this.store.name, t), qr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return xe("SimpleDb", "COUNT", this.store.name), qr(this.store.count());
    ...
    t.prototype.Ed = function(t) {
        ...
        var n = [];
        return new We((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new Cr(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof We) {
                        var u = s.catch((function(t) {
                            return o.done(), We.reject(t);
                        }));
                        n.push(u);
                    }
...
function Gr(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(n) >= 0) {
            ...
            var r = new E("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + n + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return jr || (jr = !0, 
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ var Br = /** @class */ function() {
    function t(
    /**
    ...
    return t.Id = function(e, n, r, i) {
        ...
        return Ue("" !== e.uid, "UserID must not be an empty string."), new t(e.t() ? e.uid : "", n, r, i);
        ...
        return this.Ad(t).next((function(e) {
            ...
            return e.lastStreamToken = n.toBase64(), Qr(t).put(e);
        }));
        ...
        return this.Ad(t).next((function(n) {
            // We can't store the resumeToken as a ByteString in IndexedDB, so we
            // convert it to a Base64 string for storage.
            return n.lastStreamToken = e.toBase64(), Qr(t).put(n);
        }));
    }, t.prototype.dh = function(t, e, n, r) {
        var i = this, o = Yr(t), s = Wr(t);
        ...
        return s.add({}).next((function(u) {
            Ue("number" == typeof u, "Auto-generated key is not a number");
            for (var a = new Ge(u, e, n, r), h = i.serializer.Pd(i.userId, a), c = [], f = new F((function(t, e) {
                return Pe(t.K(), e.K());
            })), l = 0, p = r; l < p.length; l++) {
                var d = p[l], y = pi.key(i.userId, d.key.path, u);
                f = f.add(d.key.path.L()), c.push(s.put(h)), c.push(o.put(y, pi.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                c.push(i.ur.Vd(t, e));
            })), t.rr((function() {
                i.wd[u] = a.keys();
            })), We.Ki(c).next((function() {
                return a;
            }));
        }));
        ...
        return Wr(t).get(e).next((function(t) {
            return t ? (Ue(t.userId === n.userId, "Unexpected user '" + t.userId + "' for mutation batch " + e), 
            n.serializer.gd(t)) : null;
        }));
    }, t.prototype.Th = function(t, e) {
        var n = this;
        return this.wd[e] ? We.resolve(this.wd[e]) : this.Ph(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.wd[e] = r, r;
            }
        ...
        return Wr(t).md({
            ...
            e.userId === n.userId && (Ue(e.batchId >= r, "Should have found mutation after " + r), 
        ...
        return Wr(t).ld(li.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return e.serializer.gd(t);
            }));
        }));
    }, t.prototype._r = function(t, e) {
        var n = this, r = pi.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return Yr(t).md({
            range: i
        }, (function(r, i, s) {
            var u = r[0], a = r[1], h = r[2], c = Or(a);
            ...
            return Wr(t).get(h).next((function(t) {
                if (!t) throw Le("Dangling document-mutation reference found: " + r + " which points to " + h);
                Ue(t.userId === n.userId, "Unexpected user '" + t.userId + "' for mutation batch " + h), 
        ...
        var n = this, r = new F(Pe), i = [];
        return e.forEach((function(e) {
            var o = pi.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = Yr(t).md({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], h = Or(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(u);
        })), We.Ki(i).next((function() {
            return n.pd(t, r);
        }));
    }, t.prototype.Vr = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = pi.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new F(Pe);
        return Yr(t).md({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], h = t[2], c = Or(a);
            s === n.userId && r.q(c) ? 
        ...
        return e.forEach((function(e) {
            i.push(Wr(t).get(e).next((function(t) {
                if (null === t) throw Le("Dangling document-mutation reference found, which points to " + e);
                Ue(t.userId === n.userId, "Unexpected user '" + t.userId + "' for mutation batch " + e), 
        ...
        var n = this;
        return Kr(t.yd, this.userId, e).next((function(r) {
            return t.rr((function() {
                n.Xh(e.batchId);
            })), We.forEach(r, (function(e) {
                return n.Jo.bd(t, e);
            }));
        }));
        ...
        return this.Rd(t).next((function(n) {
            if (!n) return We.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(pi.prefixForUser(e.userId)), i = [];
            return Yr(t).md({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
                ...
                Ue(0 === i.length, "Document leak -- detected dangling mutation references when queue is empty. Dangling keys: " + i.map((function(t) {
                    return t.K();
                })));
            }));
        }));
    }, t.prototype.Mi = function(t, e) {
        return zr(t, this.userId, e);
    }, 
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    t.prototype.Ad = function(t) {
        var e = this;
        return Qr(t).get(this.userId).next((function(t) {
            return t || new fi(e.userId, -1, 
            /*lastStreamToken=*/ "");
        }));
    }, t;
}();
 ...
 */ function zr(t, e, n) {
    var r = pi.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return Yr(t).md({
        range: o,
        Td: !0
    }, (function(t, n, r) {
 ...
 */ function Kr(t, e, n) {
    var r = t.store(li.store), i = t.store(pi.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.md({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    o.push(a.next((function() {
        Ue(1 === u, "Dangling document-mutation reference found: Missing batch " + n.batchId);
    })));
    for (var h = [], c = 0, f = n.mutations; c < f.length; c++) {
        var l = f[c], p = pi.key(e, l.key.path, n.batchId);
        o.push(i.delete(p)), h.push(l.key);
    }
    return We.Ki(o).next((function() {
        return h;
    }));
}
 ...
 */ function Wr(t) {
    return xi.ed(t, li.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Yr(t) {
    return xi.ed(t, pi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Qr(t) {
    return xi.ed(t, fi.store);
}
 ...
 */ var Jr = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.vd(t).next((function(n) {
            var r = new br(n.highestTargetId);
        ...
        return this.Fd(t, e.targetId).next((function() {
            return Hr(t).delete(e.targetId);
        })).next((function() {
            return n.vd(t);
        })).next((function(e) {
            return Ue(e.targetCount > 0, "Removing from an empty target cache"), e.targetCount -= 1, 
            n.Sd(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.Xs = function(t, e) {
        ...
        return (n = t, xi.ed(n, bi.store)).put(bi.key, e);
        /**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */        var n;
    }, t.prototype.Cd = function(t, e) {
        return Hr(t).put(this.serializer.Md(e));
    }, 
    /**
    ...
    t.prototype.kd = function(t, e) {
        ...
        // depends on the queryTargets index to be efficient.
                return Hr(t).md({
            range: i,
            index: gi.queryTargetsIndexName
        }, (function(t, r, i) {
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = Vr(e.path);
            i.push(o.put(new wi(n, s))), i.push(r.Jo.vi(t, e));
        })), We.Ki(i);
    }, t.prototype.Sh = function(t, e, n) {
        var r = this, i = $r(t);
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        // IndexedDb.
                return We.forEach(e, (function(e) {
            var o = Vr(e.path);
            return We.Ki([ i.delete([ n, o ]), r.Jo.Di(t, e) ]);
        }));
    }, t.prototype.Fd = function(t, e) {
        var n = $r(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = $r(t), i = ue();
        return r.md({
            range: n,
            Td: !0
        }, (function(t, e, n) {
            var r = Or(t[1]), o = new O(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.Mi = function(t, e) {
        var n = Vr(e.path), r = IDBKeyRange.bound([ n ], [ Me(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return $r(t).md({
 ...
 */ function Hr(t) {
    return xi.ed(t, gi.store);
}

function Xr(t) {
    return Pr.ed(t, bi.store).get(bi.key).next((function(t) {
        return Ue(null !== t, "Missing metadata row."), t;
    }));
}
 ...
 */ var ti = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return ni(t).get(ri(e)).next((function(t) {
            return n.xd(t);
        }));
    }, 
    /**
    ...
    t.prototype.Qd = function(t, e) {
        var n = this, r = ee(), i = new P(O.F);
        return this.qd(t, e, (function(t, e) {
            var o = n.xd(e);
            o ? (r = r.it(t, o), i = i.it(t, ii(e))) : (r = r.it(t, null), i = i.it(t, 0));
        })).next((function() {
            return {
                Wd: r,
                jd: i
        ...
        if (n.isEqual(x.MIN)) {
            ...
            /* open= */ !0), s.index = mi.collectionReadTimeIndex;
        }
        return ni(t).md(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                ...
                e.path.q(u.key.path) ? u instanceof xt && e.matches(u) && (i = i.it(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    }, t.prototype.ea = function(t, e) {
        var n = this, r = te(), i = this.serializer.Kd(e), o = ni(t), s = IDBKeyRange.lowerBound(i, !0);
        return o.md({
        ...
        return ei(t).get(vi.key).next((function(t) {
            return Ue(!!t, "Missing document cache metadata"), t;
        }));
    }, t.prototype.Od = function(t, e) {
        return ei(t).put(vi.key, e);
    }, 
    /**
 ...
 */ function ei(t) {
    return xi.ed(t, vi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function ni(t) {
    return xi.ed(t, mi.store);
}
 ...
 */ function ii(t) {
    ...
    if (t.document) e = t.document; else if (t.unknownDocument) e = t.unknownDocument; else {
        if (!t.noDocument) throw Le("Unknown remote document type");
        e = t.noDocument;
    }
 ...
 */ ti.Hd = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Yd = t, r.wh = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.Xd = new je((function(t) {
            return t.toString();
        })), r;
    }
    return t(n, e), n.prototype.nr = function(t) {
        var e = this, n = [], r = 0, i = new F((function(t, e) {
            return Pe(t.K(), e.K());
        }));
        return this.zi.forEach((function(o, s) {
            ...
            if (s) {
                ...
                var c = e.Yd.serializer.Zd(new Rt(o, x.S()), e.readTime);
                n.push(e.Yd.Yi(t, o, c));
            } else n.push(e.Yd.Zi(t, o));
        })), i.forEach((function(r) {
            n.push(e.Yd.ur.Vd(t, r));
        })), n.push(this.Yd.updateMetadata(t, r)), We.Ki(n);
...
var oi = /** @class */ function() {
    ...
    return t.prototype.Vd = function(t, e) {
        return this.tf.add(e), We.resolve();
    }, t.prototype.Pr = function(t, e) {
        return We.resolve(this.tf.getEntries(e));
    }, t;
}(), si = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.B(), n = t.L(), r = this.index[e] || new F(V.F), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.B(), n = t.L(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new F(V.F)).j();
    }, t;
}(), ui = 10, ai = /** @class */ function() {
    function t(t) {
        this.serializer = t;
    }
    /**
     ...
     */    return t.prototype.createOrUpgrade = function(t, e, n, r) {
        var i = this;
        Ue(n < r && n >= 0 && r <= ui, "Unexpected schema upgrade from v" + n + " to v" + r + ".");
        var o = new Mr(e);
        n < 1 && r >= 1 && (function(t) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(wi.store), t.deleteObjectStore(gi.store), t.deleteObjectStore(bi.store);
     ...
     */
            return function(t) {
                ...
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, x.MIN.k(), 
                /*targetCount=*/ 0);
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(li.store).ld().next((function(n) {
                    t.deleteObjectStore(li.store), t.createObjectStore(li.store, {
                        keyPath: li.keyPath,
                        autoIncrement: !0
                    }).createIndex(li.userMutationsIndex, li.userMutationsKeyPath, {
                        unique: !0
                    });
                    var r = e.store(li.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return We.Ki(i);
                }));
        ...
        var e = 0;
        return t.store(mi.store).md((function(t, n) {
            e += ii(n);
        })).next((function() {
            var n = new vi(e);
        ...
        var e = this, n = t.store(fi.store), r = t.store(li.store);
        return n.ld().next((function(n) {
            return We.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.ld(li.userMutationsIndex, i).next((function(r) {
                    return We.forEach(r, (function(r) {
                        Ue(r.userId === n.userId, "Cannot process batch " + r.batchId + " from unexpected user");
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        var e = t.store(wi.store), n = t.store(mi.store);
        return Zr(t).next((function(t) {
            ...
            return n.md((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? We.resolve() : function(n) {
                        return e.put(new wi(0, Vr(n), t));
                    }(o);
                })));
            })).next((function() {
                return We.Ki(r);
        ...
        var n = e.store(Ti.store), r = new si, i = function(t) {
            if (r.add(t)) {
                var e = t.B(), i = t.L();
                return n.put({
                    collectionId: e,
        ...
        // Index existing remote documents.
                return e.store(mi.store).md({
            Td: !0
        }, (function(t, e) {
            var n = new V(t);
            return i(n.L());
        })).next((function() {
            return e.store(pi.store).md({
                Td: !0
            }, (function(t, e) {
                t[0];
                var n = t[1], r = (t[2], Or(n));
                return i(r.L());
            }));
        }));
    }, t.prototype.rewriteCanonicalIds = function(t) {
        var e = this, n = t.store(gi.store);
...
/** Name of the IndexedDb object store.  */ fi.store = "mutationQueues", 
...
gi.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
gi.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store. */ function Ii(t) {
    ...
    t.createObjectStore(gi.store, {
        keyPath: gi.keyPath
    }).createIndex(gi.queryTargetsIndexName, gi.queryTargetsKeyPath, {
        unique: !0
...
/** Name of the IndexedDb object store. */ Ei.store = "clientMetadata", 
/** Keys are automatically assigned via the clientId properties. */
Ei.keyPath = "clientId";

var Ni = r(r(r([ fi.store, li.store, pi.store, mi.store, gi.store, ci.store, bi.store, wi.store ], [ Ei.store ]), [ vi.store ]), [ Ti.store ]), Ai = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.Vd = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return _i(t).ld(r).next((function(t) {
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ var Si = /** @class */ function() {
    function t(t) {
        this.sf = t;
    }
    /** Decodes a remote document from storage locally to a Document. */    return t.prototype.Gd = function(t) {
        ...
        if (t.noDocument) {
            var e = O.nt(t.noDocument.path), n = this.nf(t.noDocument.readTime);
            return new Rt(e, n, {
                hasCommittedMutations: !!t.hasCommittedMutations
            });
        }
        if (t.unknownDocument) {
            var r = O.nt(t.unknownDocument.path), i = this.nf(t.unknownDocument.version);
            return new Vt(r, i);
        }
        return Le("Unexpected DbRemoteDocument");
    }, 
    /** Encodes a document for storage locally. */ t.prototype.Zd = function(t, e) {
        ...
        if (t instanceof Rt) {
            ...
            return new mi(
            /* unknownDocument= */ null, new di(s, u), 
            /* document= */ null, a, n, r);
        }
        if (t instanceof Vt) {
            var h = t.key.path.j(), c = this.if(t.version);
            return new mi(new yi(h, c), 
            /* noDocument= */ null, 
            /* document= */ null, 
            /* hasCommittedMutations= */ !0, n, r);
        }
        return Le("Unexpected MaybeDocument");
    ...
    /** Encodes a batch of mutations into a DbMutationBatch for local storage. */ t.prototype.Pd = function(t, e) {
        ...
        return new li(t, e.batchId, e.Ri.toMillis(), r, i);
    }, 
    ...
    /** Decodes a DbTarget into TargetData */ t.prototype.$d = function(t) {
        var e, n = this.nf(t.readTime), r = void 0 !== t.lastLimboFreeSnapshotVersion ? this.nf(t.lastLimboFreeSnapshotVersion) : x.MIN;
        return e = void 0 !== t.query.documents ? this.sf.Kn(t.query) : this.sf.Yn(t.query), 
        new Jt(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, n, r, z.fromBase64String(t.resumeToken));
    }, 
    /** Encodes TargetData into a DbTarget for storage locally. */ t.prototype.Md = function(t) {
        ...
        // lastListenSequenceNumber is always 0 until we do real GC.
                return new gi(t.targetId, t.target.canonicalId(), n, i, t.sequenceNumber, r, e);
    }, t;
}(), Di = "Another tab has exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs.", ki = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).yd = t, r.Ch = n, r;
    }
    return t(n, e), n;
}(Je), xi = /** @class */ function() {
    function t(e, n, r, i, o, s, u, a) {
        ...
        }, this.Jo = new Li(this, o), this.df = n + t.ff, this.serializer = new Si(u), this.document = i.document, 
        this.th = new Jr(this.Jo, this.serializer), this.ur = new Ai, this.hr = new ti(this.serializer, this.ur), 
        !i.window || !i.window.localStorage) throw new E(I.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        this.window = i.window, this.Tf = this.window.localStorage;
    }
    return t.ed = function(t, e) {
        if (t instanceof ki) return Pr.ed(t.yd, e);
        throw Le("IndexedDbPersistence must use instances of IndexedDbTransaction");
    }, t.mf = function(e) {
        if (!t.Uc()) throw new E(I.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
    ...
    t.prototype.start = function() {
        var t = this;
        return Pr.Yl(this.df, ui, new ai(this.serializer)).then((function(e) {
            return t.wf = e, t.If();
        })).then((function() {
            return t.Rf(), t.Af(), t.Pf(), t.wf.runTransaction("readonly", [ bi.store ], (function(t) {
                return Zr(t);
            }));
        })).then((function(e) {
            t.Vf = new Ze(e, t.rf);
        ...
        var r = this;
        return this.lf = function(i) {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(e) {
                    return this.ko ? [ 2 /*return*/ , t(i) ] : [ 2 /*return*/ ];
                }));
            }));
        }, t(this.isPrimary);
    }, t.prototype.pf = function(t) {
        var r = this;
        this.wf.sd((function(i) {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(e) {
                    switch (e.label) {
                      case 0:
    ...
    t.prototype.If = function() {
        var t = this;
        return this.wf.runTransaction("readwrite", Ni, (function(e) {
            return Vi(e).put(new Ei(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
        ...
        var e = this;
        return Ri(t).get(ci.key).next((function(t) {
            return We.resolve(e.Df(t));
        }));
                ...
                switch (n.label) {
                  case 0:
                    ...
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(n) {
                        var r = t.ed(n, Ei.store);
                        return r.ld().next((function(t) {
                            var n = e.Ff(t, 18e5), i = t.filter((function(t) {
                                return -1 === n.indexOf(t);
                            }));
                            // Delete metadata for clients that are no longer considered active.
                                                        return We.forEach(i, (function(t) {
                  ...
                  case 1:
                    ...
                    n.sent().forEach((function(t) {
                        e.window.localStorage.removeItem(e.$f(t.clientId));
                    })), n.label = 2;
    ...
    t.prototype.bf = function(t) {
        var e = this;
        return Ri(t).get(ci.key).next((function(n) {
            ...
            if (null !== n && e.Nf(n.leaseTimestampMs, 5e3) && !e.Mf(n.ownerId)) {
                ...
                if (!e.Df(n)) {
                    ...
                    throw new E(I.FAILED_PRECONDITION, Di);
                    return !1;
                }
            }
            return !(!e.networkEnabled || !e.inForeground) || Vi(t).ld().next((function(t) {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.xf(), [ 4 /*yield*/ , this.wf.runTransaction("readwrite", [ ci.store, Ei.store ], (function(e) {
    ...
    t.prototype.Ff = function(t, e) {
        ...
        var t = this;
        return this.wf.runTransaction("readonly", [ Ei.store ], (function(e) {
            return Vi(e).ld().next((function(e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return t.Uc() ? (e = r + t.ff, [ 4 /*yield*/ , Pr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
        ...
        return Br.Id(t, this.serializer, this.ur, this.Jo);
        ...
        return this.wf.runTransaction(o, Ni, (function(o) {
            return i = new ki(o, r.Vf.next()), "readwrite-primary" === e ? r.yf(o).next((function(t) {
                return !!t || r.bf(o);
            })).next((function(e) {
                if (!e) throw Re("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.$a.qr((function() {
                    return r.lf(!1);
                })), new E(I.FAILED_PRECONDITION, Qe);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.Uf = function(t) {
        var e = this;
        return Ri(t).get(ci.key).next((function(t) {
            if (null !== t && e.Nf(t.leaseTimestampMs, 5e3) && !e.Mf(t.ownerId) && !e.Df(t) && !t.allowTabSynchronization) throw new E(I.FAILED_PRECONDITION, Di);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.vf = function(t) {
        ...
        return n.get(ci.key).next((function(t) {
            return e.Df(t) ? (xe("IndexedDbPersistence", "Releasing primary lease."), n.delete(ci.key)) : We.resolve();
        }));
    }, 
 ...
 */ function Vi(t) {
    return t.store(Ei.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ xi.ff = "main";

var Li = /** @class */ function() {
    function t(t, e) {
        this.db = t, this.Qf = null, this.bo = new an(this, e);
    }
    ...
    t.prototype.Kf = function(t, e) {
        return this.Qf.Mi(e) ? We.resolve(!0) : function(t, e) {
            var n = !1;
            return Qr(t).Ed((function(r) {
                return zr(t, r, e).next((function(t) {
                    return t && (n = !0), We.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
            ...
            if (u <= e) {
                var a = n.Kf(t, s).next((function(e) {
                    ...
                    return o++, r.tr(t, s).next((function() {
                        return r.Zi(s), $r(t).delete([ 0, Vr(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var Oi = /** @class */ function() {
    ...
    return t.prototype.Rd = function(t) {
        return We.resolve(0 === this.ar.length);
    }, t.prototype.mh = function(t, e, n) {
        var r = e.batchId, i = this.Hf(r, "acknowledged");
        return Ue(0 === i, "Can only acknowledge the first batch in the mutation queue"), 
        // Verify that the batch in the queue is the one to be acknowledged.
        this.ar[i], this.lastStreamToken = n, We.resolve();
    }, t.prototype.ph = function(t) {
        return We.resolve(this.lastStreamToken);
    }, t.prototype.yh = function(t, e) {
        return this.lastStreamToken = e, We.resolve();
    }, t.prototype.dh = function(t, e, n, r) {
        var i = this.Gf;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.zf = this.zf.add(new Ke(a.key, i)), this.ur.Vd(t, a.key.path.L());
        }
        return We.resolve(o);
    }, t.prototype.Ph = function(t, e) {
        return We.resolve(this.Jf(e));
    }, t.prototype.Th = function(t, e) {
        var n = this.Jf(e);
        return We.resolve(n.keys());
    }, t.prototype.xh = function(t, e) {
        var n = e + 1, r = this.Yf(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return We.resolve(this.ar.length > i ? this.ar[i] : null);
    }, t.prototype.gh = function() {
        return We.resolve(0 === this.ar.length ? -1 : this.Gf - 1);
    }, t.prototype.hh = function(t) {
        return We.resolve(this.ar.slice());
    }, t.prototype._r = function(t, e) {
        ...
        // because it precedes all other segments in an ordered traversal.
                O.st(i) || (i = i.child(""));
        var o = new Ke(new O(i), 0), s = new F(Pe);
        ...
        var n = this;
        Ue(0 === this.Hf(e.batchId, "removed"), "Can only remove the first entry of the mutation queue"), 
        this.ar.shift();
        var r = this.zf;
        return We.forEach(e.mutations, (function(i) {
        ...
        var n = new Ke(e, 0), r = this.zf.Nt(n);
        return We.resolve(e.isEqual(r && r.key));
    }, t.prototype.Rh = function(t) {
        return this.ar.length, We.resolve();
    }, 
    /**
 ...
 */
Pi.Hd = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Yd = t, n;
    }
    return t(n, e), n.prototype.nr = function(t) {
        var e = this, n = [];
...
var Ci = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.nT = new ze, this.targetCount = 0, this.iT = br.p_();
    }
    return t.prototype.Xs = function(t, e) {
        ...
        return We.resolve(this.sT);
    }, t.prototype.Qh = function(t) {
        return this.highestTargetId = this.iT.next(), We.resolve(this.highestTargetId);
    }, t.prototype.$h = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.iT = new br(e), this.highestTargetId = e), t.sequenceNumber > this.sT && (this.sT = t.sequenceNumber);
    }, t.prototype.Wh = function(t, e) {
        return this.Cd(e), this.targetCount += 1, We.resolve();
    }, t.prototype.Nh = function(t, e) {
        return this.Cd(e), We.resolve();
    }, t.prototype.Nd = function(t, e) {
        ...
        return this.nT.Ni(e), We.resolve();
    }, t.prototype.Gh = function(t, e) {
        var n = this.nT.$i(e);
        return We.resolve(n);
    }, t.prototype.Mi = function(t, e) {
        return We.resolve(this.nT.Mi(e));
    }, t;
}(), Mi = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.clientId = t, this.rT = {}, this.Vf = new Ze(0), this.hf = !1, this.hf = !0, 
        this.Jo = e(this), this.th = new Ci(this), this.ur = new oi, this.hr = new Pi(this.ur, (function(t) {
            return n.Jo.oT(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.rT[t.s()];
        return e || (e = new Oi(this.ur, this.Jo), this.rT[t.s()] = e), e;
    }, t.prototype.eh = function() {
        return this.th;
    }, t.prototype.Zo = function() {
        return this.hr;
        ...
        return We.Gi(Object.values(this.rT).map((function(n) {
            return function() {
                return n.Mi(t, e);
            };
        })));
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Ch = t, n;
    }
    return t(n, e), n;
}(Je), qi = /** @class */ function() {
    function t(t) {
    ...
    return t._T = function(e) {
        ...
        return this.lT.delete(e), We.resolve();
    }, t.prototype.Di = function(t, e) {
        return this.lT.add(e), We.resolve();
    }, t.prototype.bd = function(t, e) {
        return this.lT.add(e), We.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        ...
        // Remove newly orphaned documents.
                return We.forEach(this.lT, (function(r) {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    return i.sent(), this.mT = this.ET(t), this.Wu = this.wT(t), this.W_ = this.IT(t), 
                    this.mc = this.RT(t), this.AT = this.PT(t), this.X_.$u = function(t) {
                        return r.mc.B_(t, 1 /* SharedClientState */);
                    }, this.W_.mc = this.mc, this.X_.mc = this.mc, [ 4 /*yield*/ , this.X_.start() ];

                  case 2:
                    return i.sent(), [ 4 /*yield*/ , this.W_.start() ];

                  case 3:
                    return i.sent(), [ 4 /*yield*/ , this.Wu.start() ];

                  case 4:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return i.sent(), [ 4 /*yield*/ , this.persistence.gf((function(t) {
                        return e(r, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
        ...
        return new kr(this.mc);
    }, t.prototype.ET = function(t) {
        return null;
    }, t.prototype.wT = function(t) {
        return new hn(this.persistence, new Rr, t.VT);
    }, t.prototype.TT = function(t) {
        return new Mi(t.clientId, qi._T);
    }, t.prototype.IT = function(t) {
        var e = this;
        return new hr(this.Wu, t.bu, t.Nr, (function(t) {
            return e.mc.B_(t, 0 /* RemoteStore */);
        }), t.platform.gT());
    }, t.prototype.fT = function(t) {
        return new wr;
    }, t.prototype.RT = function(t) {
        return new Sr(this.Wu, this.W_, this.X_, t.VT, t.Z_);
    }, t.prototype.clearPersistence = function(t) {
        throw new E(I.FAILED_PRECONDITION, "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.");
    }, t;
}(), Gi = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.ET = function(t) {
        var e = this.persistence.Jo.bo;
        return new un(e, t.Nr);
    }, n.prototype.TT = function(t) {
        var e = xi.qf(t.pT), n = t.platform.yT(t.pT.cn);
        return xi.mf({
            ...
            $a: t.Nr,
            serializer: n,
            Ef: sn.Io(t.bT.cacheSizeBytes),
            rf: this.X_
        });
    }, n.prototype.fT = function(t) {
        if (t.bT.synchronizeTabs) {
            if (!gr.Uc(t.platform)) throw new E(I.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            var e = xi.qf(t.pT);
            return new gr(t.Nr, t.platform, e, t.clientId, t.VT);
        }
        return new wr;
    }, n.prototype.clearPersistence = function(t) {
        var e = xi.qf(t);
        return xi.clearPersistence(e);
    }, n;
     ...
     */
    r) {
        this.platform = t, this.pT = e, this.credentials = n, this.Nr = r, this.clientId = Oe.mi()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials.l((function(s) {
            if (!o) return o = !0, xe("FirestoreClient", "Initializing. user=", s.uid), n.ST(t, e, s, i).then(r.resolve, r.reject);
            n.Nr.qr((function() {
                return n.Dc(s);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.ST = function(t, r, i, o) {
        return e(this, void 0, void 0, (function() {
            var s, u, a, h, c = this;
            return n(this, (function(f) {
                switch (f.label) {
                  case 0:
                    return f.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.DT(this.pT) ];

                  case 1:
                    return s = f.sent(), u = this.platform.yT(this.pT.cn), a = new sr(this.Nr, s, this.credentials, u), 
                  ...
                  case 2:
                    return f.sent(), this.persistence = t.persistence, this.X_ = t.X_, this.Wu = t.Wu, 
     ...
     */
    t.prototype.vT = function() {
        if (this.Nr.Hr) throw new E(I.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.Dc = function(t) {
        return this.Nr.no(), xe("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.mc.Dc(t);
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return this.vT(), this.Nr.enqueue((function() {
            ...
            throw new E(I.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)");
        }));
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return e = n.sent(), r = new Er(t, e.zh), i = r.k_(e.documents), [ 2 /*return*/ , r.nr(i, 
...
var Wi = /** @class */ function() {
    ...
    return t.prototype.BT = function(t) {
        switch (X(t)) {
          ...
          case 6 /* BlobValue */ :
            return new Vn(ot(t.bytesValue));

          case 7 /* RefValue */ :
            return this.QT(t.referenceValue);

          case 8 /* GeoPointValue */ :
            return new Bn(t.geoPointValue.latitude, t.geoPointValue.longitude);
        ...
        var e = V.G(t);
        Ue(Ae(e), "ReferenceValue is not valid " + t);
        var n = new qe(e.get(1), e.get(3)), r = new O(e.M(5));
        return n.isEqual(this.firestore.KT) || 
        // TODO(b/64130202): Somehow support foreign references.
        Re("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.firestore.KT.projectId + "/" + this.firestore.KT.database + ") instead."), 
        new Zi(r, this.firestore, this.converter);
    }, t;
}(), Yi = sn.Po, Qi = /** @class */ function() {
    function t(t) {
        var e, n;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new E(I.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else vn("settings", "non-empty string", "host", t.host), this.host = t.host, gn("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (Nn("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling" ]), 
        gn("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        gn("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), 
        ...
        gn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = sn.po; else {
            if (t.cacheSizeBytes !== Yi && t.cacheSizeBytes < sn.Vo) throw new E(I.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + sn.Vo);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        gn("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(r, i, o) {
        var s = this;
        if (void 0 === o && (o = new ji), this.GT = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.zT = new en, this.INTERNAL = {
            delete: function() {
            ...
            var u = r;
            this.GT = u, this.KT = t.YT(u), this.XT = u.name, this.ZT = new _(i);
        } else {
            var a = r;
            if (!a.projectId) throw new E(I.INVALID_ARGUMENT, "Must provide projectId");
            this.KT = new qe(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.XT = "[DEFAULT]", this.ZT = new A;
        }
        this.tm = o, this.em = new Qi({}), this.sm = this.nm(this.KT);
    }
    return t.prototype.settings = function(t) {
        ln("Firestore.settings", arguments, 1), yn("Firestore.settings", "object", 1, t);
        var e = new Qi(t);
        if (this.JT && !this.em.isEqual(e)) throw new E(I.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
            ...
            switch (t.type) {
              case "gapi":
                ...
                // Make sure this really is a Gapi client.
                                return Ue(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty), "unexpected gapi interface"), 
                new D(e, t.V || "0");
              ...
              default:
                throw new E(I.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        ...
        var e, n;
        if (this.JT) throw new E(I.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.JT && !this.JT.FT) throw new E(I.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new $e, [ 2 /*return*/ , (this.zT.Jr((function() {
                    return e(r, void 0, void 0, (function() {
                        var e, r;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), e = this.om(), [ 4 /*yield*/ , this.tm.clearPersistence(e) ];
        ...
        if (this.HT(), Ki(t)) return this.am(t);
        yn("Firestore.onSnapshotsInSync", "function", 1, t);
        var e = {
            next: t
        };
        return this.am(e);
        ...
        return new Fe(this.KT, this.XT, this.em.host, this.em.ssl, this.em.forceLongPolling);
    }, t.prototype.rm = function(t, e) {
        var n = this.om();
        return this.JT = new Bi(_e.Lt(), n, this.ZT, this.zT), this.JT.start(t, e);
    }, t.prototype.nm = function(t) {
        var e = new Ne(t, {
            dn: _e.Lt().dn
        });
        return new Hn(e, (function(e) {
            if (e instanceof Zi) {
                var n = t, r = e.firestore.KT;
                if (!r.isEqual(n)) throw new E(I.INVALID_ARGUMENT, "Document reference is for database " + r.projectId + "/" + r.database + " but should be for database " + n.projectId + "/" + n.database);
                return new Jn(t, e.um);
            }
            return e;
        }));
    }, t.YT = function(t) {
        if (e = t.options, "projectId", !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new E(I.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
        var e, n = t.options.projectId;
        // Export the classes with a private constructor (it will fail if invoked
        // at runtime). Note that this still allows instanceof checks.
        // We're treating the variables as class names, so disable checking for lower
        // case variable names.
                if (!n || "string" != typeof n) throw new E(I.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new qe(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.GT) throw new E(I.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.GT;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return ln("Firestore.collection", arguments, 1), yn("Firestore.collection", "non-empty string", 1, t), 
        this.HT(), new io(V.G(t), this);
    }, t.prototype.doc = function(t) {
        return ln("Firestore.doc", arguments, 1), yn("Firestore.doc", "non-empty string", 1, t), 
        this.HT(), Zi.cm(V.G(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (ln("Firestore.collectionGroup", arguments, 1), yn("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new E(I.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.HT(), new no(new Ut(V.H, t), this);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return ln("Firestore.runTransaction", arguments, 1), yn("Firestore.runTransaction", "function", 1, t), 
        this.HT().transaction((function(n) {
            return t(new Hi(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.HT(), new Xi(this);
        ...
        switch (ln("Firestore.setLogLevel", arguments, 1), yn("Firestore.setLogLevel", "non-empty string", 1, t), 
        t) {
          case "debug":
            ke(s.DEBUG);
            break;
          ...
          default:
            throw new E(I.INVALID_ARGUMENT, "Invalid log level: " + t);
        }
    }, 
    ...
    return t.prototype.get = function(t) {
        var e = this;
        ln("Transaction.get", arguments, 1);
        var n = ao("Transaction.get", t, this.lm);
        return this.dm.pu([ n.um ]).then((function(t) {
            if (!t || 1 !== t.length) return Le("Mismatch in docs returned from document lookup.");
            var r = t[0];
            if (r instanceof Rt) return new to(e.lm, n.um, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.fm);
            if (r instanceof xt) return new to(e.lm, n.um, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.fm);
            throw Le("BatchGetDocumentsRequest returned unexpected document type: " + r.constructor.name);
        }));
    }, t.prototype.set = function(t, e, n) {
        dn("Transaction.set", arguments, 2, 3);
        var r = ao("Transaction.set", t, this.lm);
        n = oo("Transaction.set", n);
        var i = co(r.fm, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.lm.sm.pa(s, o, n.mergeFields) : this.lm.sm.Va(s, o);
        return this.dm.set(r.um, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof Un ? (pn("Transaction.update", arguments, 3), 
        r = ao("Transaction.update", t, this.lm), i = this.lm.sm.Sa("Transaction.update", e, n, o)) : (ln("Transaction.update", arguments, 2), 
        r = ao("Transaction.update", t, this.lm), i = this.lm.sm.ya("Transaction.update", e)), 
        this.dm.update(r.um, i), this;
    }, t.prototype.delete = function(t) {
        ln("Transaction.delete", arguments, 1);
        var e = ao("Transaction.delete", t, this.lm);
    ...
    return t.prototype.set = function(t, e, n) {
        dn("WriteBatch.set", arguments, 2, 3), this.Em();
        var r = ao("WriteBatch.set", t, this.lm);
        n = oo("WriteBatch.set", n);
        var i = co(r.fm, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.lm.sm.pa(s, o, n.mergeFields) : this.lm.sm.Va(s, o);
        return this.Tm = this.Tm.concat(u.da(r.um, bt.NONE)), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Em(), "string" == typeof e || e instanceof Un ? (pn("WriteBatch.update", arguments, 3), 
        r = ao("WriteBatch.update", t, this.lm), i = this.lm.sm.Sa("WriteBatch.update", e, n, o)) : (ln("WriteBatch.update", arguments, 2), 
        r = ao("WriteBatch.update", t, this.lm), i = this.lm.sm.ya("WriteBatch.update", e)), 
        this.Tm = this.Tm.concat(i.da(r.um, bt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        ln("WriteBatch.delete", arguments, 1), this.Em();
        var e = ao("WriteBatch.delete", t, this.lm);
        return this.Tm = this.Tm.concat(new At(e.um, bt.NONE)), this;
    }, t.prototype.commit = function() {
        return this.Em(), this.mm = !0, this.Tm.length > 0 ? this.lm.HT().write(this.Tm) : Promise.resolve();
    }, t.prototype.Em = function() {
        if (this.mm) throw new E(I.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Zi = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.cm = function(e, n, r) {
        if (e.length % 2 != 0) throw new E(I.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.K() + " has " + e.length);
        ...
        get: function() {
            return new io(this.um.path.L(), this.firestore, this.fm);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (ln("DocumentReference.collection", arguments, 1), yn("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new E(I.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = V.G(t);
        return new io(this.um.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw An("isEqual", "DocumentReference", 1, e);
        return this.firestore === e.firestore && this.um.isEqual(e.um) && this.fm === e.fm;
    }, t.prototype.set = function(t, e) {
        dn("DocumentReference.set", arguments, 1, 2), e = oo("DocumentReference.set", e);
        var n = co(this.fm, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.sm.pa(i, r, e.mergeFields) : this.firestore.sm.Va(i, r);
        return this.JT.write(o.da(this.um, bt.NONE));
    }, t.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof Un ? (pn("DocumentReference.update", arguments, 2), 
        n = this.firestore.sm.Sa("DocumentReference.update", t, e, r)) : (ln("DocumentReference.update", arguments, 1), 
        n = this.firestore.sm.ya("DocumentReference.update", t)), this.JT.write(n.da(this.um, bt.exists(!0)));
    }, t.prototype.delete = function() {
        return ln("DocumentReference.delete", arguments, 0), this.JT.write([ new At(this.um, bt.NONE) ]);
    }, t.prototype.onSnapshot = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        dn("DocumentReference.onSnapshot", arguments, 1, 4);
        var n, r = {
            includeMetadataChanges: !1
        }, i = 0;
        "object" != typeof t[i] || Ki(t[i]) || (Nn("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        gn("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return Ki(t[i]) ? n = t[i] : (yn("DocumentReference.onSnapshot", "function", i, t[i]), 
        mn("DocumentReference.onSnapshot", "function", i + 1, t[i + 1]), mn("DocumentReference.onSnapshot", "function", i + 2, t[i + 2]), 
        n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new zi({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new to(n.firestore, n.um, r, t.fromCache, t.hasPendingWrites, n.fm));
                }
            },
            error: r
        }), o = this.JT.listen(Ut.ve(this.um.path), i, t);
        return function() {
            i.OT(), n.JT.fc(o);
        };
    }, t.prototype.get = function(t) {
        var e = this;
        return dn("DocumentReference.get", arguments, 0, 1), uo("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.HT().$T(e.um).then((function(t) {
                n(new to(e.firestore, e.um, t, 
                /*fromCache=*/ !0, t instanceof xt && t.te, e.fm));
            }), r) : e.Im(n, r, t);
        }));
        ...
        var r = this.wm({
            ...
            next: function(i) {
                ...
                e(new E(I.UNAVAILABLE, "Failed to get document because the client is offline.")) : i.exists && i.metadata.fromCache && n && "server" === n.source ? e(new E(I.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : t(i);
            },
            error: e
        });
    ...
    return t.prototype.data = function(t) {
        if (dn("DocumentSnapshot.data", arguments, 0, 1), t = so("DocumentSnapshot.data", t), 
        this.Rm) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.fm) {
                var e = new eo(this.lm, this.um, this.Rm, this.Am, this.Pm);
        ...
        if (dn("DocumentSnapshot.get", arguments, 1, 2), e = so("DocumentSnapshot.get", e), 
        this.Rm) {
            var n = this.Rm.data().field($n("DocumentSnapshot.get", t));
            if (null !== n) return new Wi(this.lm, this.lm._m(), e.serverTimestamps, this.fm).BT(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.um.path.B();
        ...
        get: function() {
            return new Zi(this.um, this.lm, this.fm);
        },
        enumerable: !0,
        configurable: !0
        ...
        get: function() {
            return new $i(this.Pm, this.Am);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw An("isEqual", "DocumentSnapshot", 1, e);
...
}(to), no = /** @class */ function() {
    function t(t, e, n) {
        this.Vm = t, this.firestore = e, this.fm = n;
    }
    return t.prototype.where = function(e, n, r) {
        var i;
        ln("Query.where", arguments, 3), En("Query.where", 3, r), function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new E(I.INVALID_ARGUMENT, "Invalid value " + In(r) + " provided to function Query.where() for its " + Sn(2) + " argument. Acceptable values: " + e.join(", "));
        }(0, [ "<", "<=", "==", ">=", ">", "array-contains", "in", "array-contains-any" ], 0, n);
        var o = $n("Query.where", e), s = Ot.G(n);
        if (o.Y()) {
            if (s === Ot.ARRAY_CONTAINS || s === Ot.ARRAY_CONTAINS_ANY) throw new E(I.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + s.toString() + "' queries on FieldPath.documentId().");
            if (s === Ot.IN) {
                this.gm(r, s);
        ...
        } else s !== Ot.IN && s !== Ot.ARRAY_CONTAINS_ANY || this.gm(r, s), i = this.firestore.sm.Da("Query.where", r, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ s === Ot.IN);
        var f = Pt.create(o, s, i);
        return this.ym(f), new t(this.Vm.Ce(f), this.firestore, this.fm);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (dn("Query.orderBy", arguments, 1, 2), mn("Query.orderBy", "non-empty string", 2, n), 
        void 0 === n || "asc" === n) r = Gt.ASCENDING; else {
            if ("desc" !== n) throw new E(I.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = Gt.DESCENDING;
        }
        if (null !== this.Vm.startAt) throw new E(I.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.Vm.endAt) throw new E(I.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var i = $n("Query.orderBy", e), o = new Wt(i, r);
        return this.bm(o), new t(this.Vm.ke(o), this.firestore, this.fm);
    }, t.prototype.limit = function(e) {
        return ln("Query.limit", arguments, 1), yn("Query.limit", "number", 1, e), _n("Query.limit", 1, e), 
        new t(this.Vm.Ne(e), this.firestore, this.fm);
    }, t.prototype.limitToLast = function(e) {
        return ln("Query.limitToLast", arguments, 1), yn("Query.limitToLast", "number", 1, e), 
        _n("Query.limitToLast", 1, e), new t(this.Vm.Fe(e), this.firestore, this.fm);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        pn("Query.startAt", arguments, 1);
        var i = this.vm("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(this.Vm.$e(i), this.firestore, this.fm);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        pn("Query.startAfter", arguments, 1);
        var i = this.vm("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t(this.Vm.$e(i), this.firestore, this.fm);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        pn("Query.endBefore", arguments, 1);
        var i = this.vm("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(this.Vm.Me(i), this.firestore, this.fm);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        pn("Query.endAt", arguments, 1);
        var i = this.vm("Query.endAt", e, n, 
        /*before=*/ !1);
        return new t(this.Vm.Me(i), this.firestore, this.fm);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw An("isEqual", "Query", 1, e);
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.vm = function(t, e, n, r) {
        if (En(t, 1, e), e instanceof to) {
            if (n.length > 0) throw new E(I.INVALID_ARGUMENT, "Too many arguments provided to " + t + "().");
            var i = e;
            if (!i.exists) throw new E(I.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
    ...
    t.prototype.Sm = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.Vm.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(st(this.firestore.KT, t.key)); else {
                var s = t.field(o.field);
                if (Q(s)) throw new E(I.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.K();
                    throw new E(I.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.Dm = function(t, e, n) {
        ...
        var r = this.Vm.Ve;
        if (e.length > r.length) throw new E(I.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.Y()) {
                if ("string" != typeof s) throw new E(I.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.Vm.He() && -1 !== s.indexOf("/")) throw new E(I.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.Vm.path.child(V.G(s));
                if (!O.st(u)) throw new E(I.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new O(u);
                i.push(st(this.firestore.KT, a));
            } else {
        ...
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        dn("Query.onSnapshot", arguments, 1, 4);
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || Ki(t[i]) || (Nn("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        gn("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), Ki(t[i]) ? n = t[i] : (yn("Query.onSnapshot", "function", i, t[i]), mn("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        mn("Query.onSnapshot", "function", i + 2, t[i + 2]), n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new zi({
            next: function(t) {
                e.next && e.next(new ro(n.firestore, n.Vm, t, n.fm));
            },
            error: r
        ...
        if (t.Ke() && 0 === t.Ve.length) throw new E(I.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        return dn("Query.get", arguments, 0, 1), uo("Query.get", t), this.Cm(this.Vm), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.HT().MT(e.Vm).then((function(t) {
                n(new ro(e.firestore, e.Vm, t, e.fm));
            }), r) : e.Im(n, r, t);
        }));
    }, t.prototype.Im = function(t, e, n) {
        var r = this.wm({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new E(I.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, 
    ...
    t.prototype.pm = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new E(I.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.Vm.He() && -1 !== t.indexOf("/")) throw new E(I.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.Vm.path.child(V.G(t));
            if (!O.st(e)) throw new E(I.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return st(this.firestore.KT, new O(e));
        }
        if (t instanceof Zi) {
            var n = t;
            return st(this.firestore.KT, n.um);
        }
        throw new E(I.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + In(t) + ".");
    }, 
    /**
    ...
    t.prototype.gm = function(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new E(I.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
        if (t.length > 10) throw new E(I.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
        if (t.indexOf(null) >= 0) throw new E(I.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new E(I.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
        ...
        if (t instanceof Pt) {
            ...
            if (t.Ge()) {
                var o = this.Vm.Se();
                if (null !== o && !o.isEqual(t.field)) throw new E(I.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.Vm.De();
                ...
                throw u === t.op ? new E(I.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new E(I.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
        ...
        if (!e.isEqual(t)) throw new E(I.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}(), ro = /** @class */ function() {
    function t(t, e, n, r) {
        this.lm = t, this.Nm = e, this.Fm = n, this.fm = r, this.$m = null, this.Mm = null, 
        this.metadata = new $i(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        dn("QuerySnapshot.forEach", arguments, 1, 2), yn("QuerySnapshot.forEach", "function", 1, t), 
        this.Fm.docs.forEach((function(r) {
            t.call(e, n.Lm(r));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new no(this.Nm, this.lm, this.fm);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (Nn("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), gn("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.Fm.ds) throw new E(I.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e, n, r) {
            if (n.cs.U()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new eo(t, e.doc.key, e.doc, n.fromCache, n._s.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new eo(t, e.doc.key, e.doc, n.fromCache, n._s.has(e.doc.key), r), s = -1, u = -1;
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw An("isEqual", "QuerySnapshot", 1, e);
        return this.lm === e.lm && this.Nm.isEqual(e.Nm) && this.Fm.isEqual(e.Fm) && this.fm === e.fm;
    }, t.prototype.Lm = function(t) {
        return new eo(this.lm, t.key, t, this.metadata.fromCache, this.Fm._s.has(t.key), this.fm);
    }, t;
}(), io = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Ut.ve(t), n, r) || this).Om = t, t.length % 2 != 1) throw new E(I.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.K() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.U() ? null : new Zi(new O(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (dn("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = Oe.mi()), yn("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new E(I.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = V.G(t);
        return Zi.cm(this.Vm.path.child(e), this.firestore, this.fm);
    }, n.prototype.add = function(t) {
        ln("CollectionReference.add", arguments, 1), yn("CollectionReference.add", "object", 1, this.fm ? this.fm.toFirestore(t) : t);
        var e = this.doc();
...
function oo(t, e) {
    ...
    if (Nn(t, e, [ "merge", "mergeFields" ]), gn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new E(I.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + In(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new E(I.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + In(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof Un;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new E(I.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}

function so(t, e) {
    return void 0 === e ? {} : (Nn(t, e, [ "serverTimestamps" ]), wn(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function uo(t, e) {
    mn(t, "object", 1, e), e && (Nn(t, e, [ "source" ]), wn(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}

function ao(t, e, n) {
    if (e instanceof Zi) {
        if (e.firestore !== n) throw new E(I.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
    throw An(t, "DocumentReference", 1, e);
}
...
var fo = kn(Ji, "Use firebase.firestore() instead."), lo = kn(Hi, "Use firebase.firestore().runTransaction() instead."), po = kn(Xi, "Use firebase.firestore().batch() instead."), yo = kn(Zi, "Use firebase.firestore().doc() instead."), mo = kn(to), vo = kn(eo), go = kn(no), wo = kn(ro), bo = kn(io, "Use firebase.firestore().collection() instead."), To = {
    Firestore: fo,
    GeoPoint: Bn,
    Timestamp: k,
    Blob: Ln,
    ...
    Commit: "commit"
}, _o = "gl-js/ fire/" + b, So = /** @class */ function() {
    function t(t) {
        this.cn = t.cn;
     ...
     */    return t.prototype.tE = function(t, e) {
            ...
            u.listenOnce(m.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case v.TIMEOUT:
                        xe("Connection", 'RPC "' + t + '" timed out'), s(new E(I.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case v.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new E(i, r.message));
                            } else s(new E(I.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        xe("Connection", 'RPC "' + t + '" failed'), s(new E(I.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.Zm, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = g(), i = {
        ...
        this.tE(i.initMessageHeaders, e), 
        ...
        var s = r.createWebChannel(o, i), u = !1, d = !1, y = new No({
            jm: function(t) {
        ...
        return m(w.EventType.OPEN, (function() {
            d || xe("Connection", "WebChannel transport opened.");
        })), m(w.EventType.CLOSE, (function() {
            d || (d = !0, xe("Connection", "WebChannel transport closed"), y.Ym());
        })), m(w.EventType.ERROR, (function(t) {
            d || (d = !0, xe("Connection", "WebChannel transport errored:", t), y.Ym(new E(I.UNAVAILABLE, "The operation could not be completed")));
        })), m(w.EventType.MESSAGE, (function(t) {
            var e;
            if (!d) {
                var n = t.data[0];
                Ue(!!n, "Got a webchannel message without data.");
                ...
                if (i) {
                    ...
                    d = !0, y.Ym(new E(u, a)), s.close();
                } else xe("Connection", "WebChannel received:", n), y.Xm(n);
            }
        })), setTimeout((function() {
 ...
 */
    !function(t, e) {
        t.INTERNAL.registerComponent(new d("firestore", (function(t) {
            return function(t, e) {
                return new Ji(t, e, new Gi);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, To)));
...
export { Do as __PRIVATE_registerFirestore };
